...
class DevStackContractTest(unittest.TestCase):
    ...
    def test_fhir_waits_for_a_healthy_database(self):
        compose = (
            REPO_ROOT
            / "projects"
            / "analyzer-harness"
        ...
        fhir = compose.split("  fhir.openelis.org:", 1)[1].split(
            "  frontend.openelis.org:", 1
        )[0]
        self.assertIn("db.openelis.org:\n        condition: service_healthy", fhir)
