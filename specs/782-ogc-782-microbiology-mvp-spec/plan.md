...
| M5  | `m5-manual-ast`                     | Manual AST setup, laboratory technique with derived measurement type, readings, S/I/R interpretation, no-breakpoint handling, repeat/retest, review, and override audit                           | US3           | Technique/measurement derivation and breakpoint interpretation unit tests, AST persistence integration tests, frontend AST interaction tests                                           | M4                 |
