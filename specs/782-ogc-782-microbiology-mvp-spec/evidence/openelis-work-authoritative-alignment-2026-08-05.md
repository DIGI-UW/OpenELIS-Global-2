...
**Remediation code through:** `cf8ac8c21`
**Remediation branch:**
...
| 9. M-04         | Work the culture case by current step                                 | MVP M4 plus T237-T242                  | Explicit primary inoculation and subculture records, same-case parent lineage, barcode-ready IDs, shared lot selection, automatic timeline projection, shared Note-backed manual observations, and a registered Playwright journey exist | Implemented, evidence pending for setup/timeline; other current-step actions remain partial |
