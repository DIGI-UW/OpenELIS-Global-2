...
| 11. M-05        | Enter and interpret AST                                               | MVP M5 plus M8 and T243-T250           | Multi-reading AST, selectable standards, repeat/retest, override/revert history, and review exist; setup confirms and snapshots the panel, standard, exact ordered drug membership, and technique; justified panel/drug adjustment, complete-set review, and ordered current-value report projection are implemented                | Partial; analyzer/QC review, analyzer provenance, repeat scope, progress counts, exact-SHA interaction evidence, and human UAT remain |
...
- **Ordered-set closure:** `1a198a765` snapshots exact panel membership,
  ...
  **Still open:**
  ...
  Analyzer/QC lifecycle, analyzer provenance, repeat scope, progress counts,
  exact-SHA Playwright, separated Grist stories,
