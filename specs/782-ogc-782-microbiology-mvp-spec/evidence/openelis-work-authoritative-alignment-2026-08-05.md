...
| 11. M-05        | Enter and interpret AST                                               | MVP M5 plus M8 and T243-T250           | Multi-reading AST, selectable standards, scoped repeat/retest, NCE Retest convergence, override/revert history, ordered panel/drug snapshots, justified adjustment, analyzer pending/results/QC states, provenance, review blockers, and durable event reconciliation are implemented                                               | Partial; worklist repeat origin, progress counts, exact-SHA interaction evidence, deployment, and human UAT remain |
...
| M-05 AST                | Manual readings, breakpoint interpretation, selectable and version-snapshotted standard, organism-default panel confirmation, immutable ordered-drug snapshot, reasoned panel adjustment, distinct laboratory technique with server-derived measurement type, reading source/matched-basis/units, no-breakpoint guidance, immutable override/revert history, analyzer result/QC lifecycle and provenance, review blockers, whole-panel/single-drug repeat, NCE Retest convergence, reagent capture | No worklist repeat origin, progress-count closure, deployed exact-SHA interaction evidence, or human acceptance                                                                                                                                                           | Preserve the delivered AST slices; complete worklist convergence, progress behavior, and acceptance evidence explicitly  |
...
- **Ordered-set closure:** `1a198a765` snapshots exact panel membership,
  ...
  **Still open:** worklist repeat origin, progress counts, exact-SHA Playwright,
