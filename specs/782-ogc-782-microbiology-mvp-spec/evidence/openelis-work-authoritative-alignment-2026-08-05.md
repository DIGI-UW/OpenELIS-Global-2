...
| 9. M-04         | Work the culture case by current step                                 | MVP M4 plus T237-T242                  | Explicit primary inoculation/subculture lineage, shared lot selection, automatic timeline plus shared Notes, critical entry points, shared NCE reporting, lost-specimen rejection, and registered Playwright journeys exist | Implemented, exact-SHA runtime evidence and human UAT pending; current-step focus remains partial |
...
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| M-04 Case Workbench     | Case creation, progress rail, typed inoculation/subculture lineage, automatic timeline plus shared Note observations, two-pass isolate work-up and identification, amendments, report release, final lock, workflow classification, sibling navigation, critical entry points, shared NCE reporting, and lost-specimen rejection | No analyzer-event reconciliation; current-step focus, compact Case Info, and sticky stage action area are incomplete; exact-SHA NCE/lost runtime and visual UAT remain open                                                                                               | Keep each remaining behavior in independent TDD/UAT stories; implemented slices are not accepted until deployed UAT      |
...
- **Automated checks passed locally:** focused JUnit service/controller tests;
  21 microbiology frontend files with 78 tests; targeted ESLint; Playwright
