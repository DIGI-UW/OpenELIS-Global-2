...
**2026-08-06 closure:** The stable R1 desktop/mobile comparison is recorded in
[`mock-comparison-r1-2026-08-06.md`](./mock-comparison-r1-2026-08-06.md). It
supersedes this pre-remediation visual record for M-03, M-04, M-05, M-07,
M-11, and M-12.
...
discard, and bacteriology/TB siblings. Patient Origin uses the deployment
vocabulary and an explicit optional requesting-location default; macro-enabled
history depends on the separate Macro Library, and visual/deployed/human acceptance
