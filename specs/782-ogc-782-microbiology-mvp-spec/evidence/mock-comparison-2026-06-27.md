...
M-03 entered remediation on 2026-08-05: the supported order state now preserves
workflow/Method metadata and shares the ruled Carbon controls, but complete
save-to-case and registered browser evidence remain open. M-04, M-05, M-07,
...
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| M-03 Program/order entry | Culture-test selection visibly derives Program = Microbiology and presents required/defaulted Culture Method plus complete microbiology details.     | R1 preserves direct/panel metadata and shares the ruled controls on modern and compatibility flows. Complete save-to-case, Program-change confirmation, visual evidence, and modern-route Playwright remain open.                   | In progress; prior label-only Playwright/UAT evidence is insufficient.                                                                                   |
...
| Isolate work-up          | Two-pass isolate work with Gram stain, colony morphology, preliminary/final ID, method, confidence, significance, and notes.                         | Actual creates/displays isolates with a smaller identity/significance surface and permits AST too early.                                                                                                                            | Blocking M-04 depth gap in R1.                                                                                                                           |
