...
M-03 entered remediation on 2026-08-05: the supported order state preserves
workflow/Method metadata, shares the ruled Carbon controls, and has typed
service-level persistence evidence, but complete save-to-case browser evidence
remains open. Patient Origin still uses hardcoded client choices rather than
deployment reference data, and macro-enabled history depends on the separate
Macro Library. M-04, M-05, M-07,
...
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| M-03 Program/order entry | Culture-test selection visibly derives Program = Microbiology and presents required/defaulted Culture Method plus complete microbiology details.     | R1 preserves direct/panel metadata, shares the ruled controls, and persists typed details through services. Patient Origin reference/default behavior, Macro consumption, complete supported save-to-case, Program-change confirmation, visual evidence, and modern-route Playwright remain open. | In progress; a hardcoded dropdown and transaction-level routing test do not establish authoritative parity.                                              |
