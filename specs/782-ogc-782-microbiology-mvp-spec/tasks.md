...
- [ ] T286 [R1] Add the M-01 Phase 1A read-only Patient Origin list under Microbiology Reference Data, reusing the same reference service and permissions. Keep full CRUD in Phase 1B. This authoritative surface was absent from the previous roadmap and is not required to complete the M-03 order-entry behavior in T284.
