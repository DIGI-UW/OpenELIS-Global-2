...
- [ ] T200 [Human UAT] Piotr completes Pass/Fail/N/A plus notes for the live combined M1/M2/M3/M4 checklist: 38 required steps across 14 stories at revision `90a25a2ee19e0282611845eca163159e84cc2bbfe55309ebf0d77d6ec7edea43`; the optional TB reflection cannot block acceptance. Automated execution cannot check off this task.
...
- [x] T222 [R1] Publish a separate M-03 Grist story with concise steps for Program derivation, controls/defaults, save-to-case, non-culture behavior, and discard confirmation. The schema-v2 AMR picker renders `R1 - M-03 - Route a culture order` independently at checklist revision `57379544553a890c9644183a09bd8f32fa17c11587cd649bbd659265bbdc62b8`; navigation remains the existing M1 UAT baseline rather than an R1 implementation gate.
...
- [x] T226 [R1] Capture and manually compare stable desktop/mobile M-03 and M-07 screenshots against the pinned OpenELIS Work sources; document every intentional difference. The final 1440x1000/mobile evidence and intentional deviations are recorded in `evidence/mock-comparison-r1-2026-08-06.md` and closed with the complete touched-surface comparison in T270.
...
- [x] T229 [R1] Deploy the exact remediation head with compatible review tooling to `amr.openelis-global.org`; verify health, supported routes, application SHA, checklist revision, and overlay rendering. The final top-of-branch target is recorded by immutable `/__review/target.json` metadata and PR #4004; the first full runtime pass was deployment `20260807T022035Z-ee1238ce1c1d` with app `ee1238ce1c1df75315b0f7791a2fd94b695149c0`, harness `f3deb02e6e45cacbe9a7ad77159c2aaf3fea8e2c`, health/smoke passed, and checklist revision `57379544553a890c9644183a09bd8f32fa17c11587cd649bbd659265bbdc62b8`.
