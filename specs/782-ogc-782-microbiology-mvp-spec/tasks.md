...
- [x] T240 [R1] Add header/isolate critical entry points and reuse the existing NCE/rejection workflow for Report NCE and Mark lost; do not introduce microbiology-only NCE storage (`28669ef18`, `b2ad1013a`, `f7aa5e20e`, `8e3337870`). Exact-SHA deployed execution and separate human UAT remain in T242.
