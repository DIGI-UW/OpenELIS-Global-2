...
**FRS version pinned:** v2.5 · 2026-05-19 17:45 UTC
...
transformation of the upstream FRS into SpecKit format — **NOT a copy**. Prose
...
- `research.md` — FRS snapshot pin (SHA `7cf6f65`), Open Question resolutions
  (Q1–Q4), rationale for the divergences from the upstream FRS
...
Two deliberate divergences from the upstream FRS are recorded in `spec.md`
Assumptions & Constraints (and `research.md` rationale):

- **Editable post-save quantities** is locked **YES** per the Jira 2026-05-19
...
- US4 (Migration & continuity + OGC-284 gap absorption) — the upstream FRS does
