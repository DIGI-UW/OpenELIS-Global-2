...
**Nodes**: 1-410 (Test Connection), 1-1031 (Edit Analyzer), 1-1488 (Add Analyzer), 1-1489 (Delete Confirmation)  
**Date**: 2025-11-19
...
### Content
- **Message**: "Are you sure you want to delete '{Analyzer Name}'? This action cannot be undone and will remove all associated field mappings."
