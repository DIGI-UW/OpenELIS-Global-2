...
> into OGC-285 milestones per the [Gap Closure Matrix](#gap-closure-matrix) at
> the bottom of this file. **No further edits to this directory** — historical
> reference only.

**Feature Branch**: `feat/ogc-284-expand-barcode`  
**Created**: 2026-02-14  
**Status**: Closed — Superseded by OGC-285 (2026-05-19). See banner above + Gap
Closure Matrix.  
...
This section enumerates OGC-284 FRs that did NOT ship as v1 acceptance criteria
intended, and maps each to the OGC-285 milestone that closes the gap.
