...
# `compose.yaml` inside projects/analyzer-harness — reference it
# there for the logs tail.
(cd projects/analyzer-harness && docker compose -f compose.yaml logs -f oe.openelis.org | grep "Started")
```
