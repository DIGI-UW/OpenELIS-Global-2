...
| Runtime expansion       | Suggest relevant dot codes and leave editable expanded text in the clinical field. | One shared `MacroTextArea` integrates culture activity and clinical history; existing payloads persist plain text. Antibiotic Exposure remains the M-03 binary choice. | Parity and cross-field reuse proved without changing clinical meaning.                         |
