...
- Jira OGC-788, status Backlog on 2026-08-04.
- Confluence page 1315209256, version 6, Microbiology workflow walkthrough v2.1.
- OpenELIS Work M-08 Markdown, rendered mock, and archived FRS.
- OGC-782 M1-M4 spec, roadmap, implementation, tests, and deployed UAT state.
...
| Microbiology order details | Shared controlled fields contain clinical history and antibiotic exposure.                                  | Suitable cross-form proof that the runtime component is reusable.             |
