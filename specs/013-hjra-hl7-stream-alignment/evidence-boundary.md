...
- Status: speculative scaffolding until matcher contract is corrected and
  documented
- Risk: current sender assumptions may not match vendor-manual identity fields

### `projects/analyzer-profiles/hl7/mindray-bs300.json`

- Status: speculative scaffolding
- Risk: inherits both the sender-identity uncertainty and the still-unproven
  BS-300 equivalence assumption
