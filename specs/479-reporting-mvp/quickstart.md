...
The built-in Sample & Testing definition starts with no selected columns to
match the canonical mock; users add the fields they need. An instance-supplied
definition may still declare explicit ordered defaults for a routine report.
