...
**Branch**: `053-tb-lab-workflow` | **Date**: 2025-12-14 | **Spec**:
`specs/053-tb-lab-workflow/spec.md` **Input**: Feature specification from
...
React pages that reuse notebook grids, bulk actions, and SampleStorageService.
...
**Structure Decision**: Single repo with backend in `src/main/java` + Liquibase
resources and frontend in `frontend/src`, leveraging existing notebook modules
and storage services; contracts kept under
`specs/053-tb-lab-workflow/contracts/`.
