...
1. Read our [Dev Environment Setup Instructions](https://uwdigi.atlassian.net/wiki/spaces/OG/pages/240844805/Dev+Environment+Setup+Instructions) on the project wiki.
2. Check out our [CONTRIBUTING guide](./CONTRIBUTING.md) for detailed contribution practices and
   [pull request tips](PULL_REQUEST_TIPS.md). 
