...
- Proper project name: "Malaria and Neglected Tropical Disease (MNTD)
  Laboratory"

## File Structure

- `MNTD Reagent inventory (2) (1).xlsx` - Source Excel file (24 sheets, 970+
  rows)
...
**OpenELIS UI**: `http://localhost:8080/OpenELIS/inventory` **Search for**:
...
**Mission accomplished: Complete MNTD inventory successfully imported into
OpenELIS with full data preservation.**
