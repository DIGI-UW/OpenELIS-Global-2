...
public interface AnalyzerFieldMappingDAO extends BaseDAO<AnalyzerFieldMapping, String> {
    ...
    /**
     * Find all mappings for an analyzer with analyzer field eagerly fetched
     * Uses JOIN FETCH to load relationships within transaction
     */
    List<AnalyzerFieldMapping> findByAnalyzerIdWithFields(String analyzerId);
    
    /**
     * Find mapping by ID with analyzer field eagerly fetched
     * Uses JOIN FETCH to load relationships within transaction
     */
