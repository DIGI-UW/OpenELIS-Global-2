...
/**
 * Line inserter for Horiba ABX Pentra 60 analyzer ASTM messages.
 *
 * <p>
 * Feature: 011-madagascar-analyzer-integration Milestone: M9 (Pentra 60)
 *
 * <p>
 * Parses ASTM LIS2-A2 messages from the Pentra 60 and creates AnalyzerResults
 * for persistence. Supports the full 26-parameter CBC with 5-part differential.
 *
 * <p>
...
public class HoribaPentra60AnalyzerLineInserter extends AnalyzerLineInserter {
    ...
    public boolean insert(List<String> lines, String currentUserId) {
        ...
        try {
            ...
            if (analyzerId == null) {
                error = "Analyzer not found in database: " + HoribaPentra60Analyzer.ANALYZER_NAME;
                return false;
            }
            ...
            error = "Error processing Pentra 60 ASTM message: " + e.getMessage();
            LogEvent.logError(e);
            return false;
        }
    }
    ...
    private String getAnalyzerId() {
        if (analyzerId == null) {
            ...
            Analyzer analyzer = analyzerService.getAnalyzerByName(HoribaPentra60Analyzer.ANALYZER_NAME);
            if (analyzer != null) {
