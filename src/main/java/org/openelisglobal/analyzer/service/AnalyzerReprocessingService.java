 ...
 * Task Reference: T091
 * 
 * Provides methods for reprocessing failed analyzer messages after mappings
 * are created.
 */
public interface AnalyzerReprocessingService {
     ...
     * 
     * This method retrieves the raw ASTM message from the error, checks if
     * active mappings exist for the analyzer, and reprocesses the message
     * through ASTMAnalyzerReader.
     * 
