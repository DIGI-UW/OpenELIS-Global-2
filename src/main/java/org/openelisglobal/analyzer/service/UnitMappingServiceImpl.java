...
@Service
@Transactional
public class UnitMappingServiceImpl extends BaseObjectServiceImpl<UnitMapping, String>
     ...
     * - If units don't match: conversion factor is required (unless rejectIfMismatch=true)
     * 
        ...
        if (mapping.getConversionFactor() == null) {
            ...
            if (mapping.getRejectIfMismatch() == null || !mapping.getRejectIfMismatch()) {
                throw new LIMSRuntimeException(
                        "Conversion factor is required when units don't match. Analyzer unit: '"
