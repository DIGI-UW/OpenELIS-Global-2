...
public class InventoryUsageDAOImpl extends BaseDAOImpl<InventoryUsage, String> implements InventoryUsageDAO {
    ...
    public List<InventoryUsage> getByTestResultId(String testResultId) throws LIMSRuntimeException {
        try {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<InventoryUsage> getByAnalysisId(String analysisId) throws LIMSRuntimeException {
        try {
