...
public class AuditTrailServiceImpl implements AuditTrailService {
    ...
    public void saveNewHistory(
        ...
        if (
            referenceTable != null &&
            !referenceTable.getKeepHistory().equals(IActionConstants.YES)
        ) {
            LogEvent.logDebug(
                "AuditTrailDAOImpl",
                "saveNewHistory()",
                "NO CHANGES: REF TABLE KEEP_HISTORY IS N"
            );
            return;
        }
        ...
        if ((sysUserId == null) || (sysUserId.length() == 0)) {
            LogEvent.logError(
                "AuditTrailDAOImpl",
                "saveNewHistory()",
                "NO CHANGES: SYS_USER_ID IS NULL"
            );
            throw new LIMSRuntimeException(
        ...
        try {
            ...
            LogEvent.logInfo(
                ...
                "saveNewHistory",
                "Created INSERT history record for table: " +
                    tableName +
                    ", referenceId: " +
                    referenceId
            );
    ...
    public void saveHistory(
        ...
        ReferenceTables referenceTables = new ReferenceTables();
        referenceTables.setTableName(tableName);
        ReferenceTables rt = referenceTablesService.getReferenceTableByName(
            referenceTables
        );
        ...
        if (rt == null) {
            ...
            // bugzilla 1926
            throw new LIMSRuntimeException(
                "Reference Table is null in AuditTrailDAOImpl saveHistory()"
            );
        }
        ...
        if ((sysUserId == null) || (sysUserId.length() == 0)) {
            ...
            // bugzilla 1926
            throw new LIMSRuntimeException(
                "System User ID is null in AuditTrailDAOImpl saveHistory() for table " +
                    tableName
            );
        }
        ...
        if (
            (newObject == null &&
                IActionConstants.AUDIT_TRAIL_UPDATE.equals(event)) ||
            existingObject == null ||
            event == null ||
            tableName == null
        ) {
        ...
        try {
            ...
            if (
                newObject != null &&
                event.equals(IActionConstants.AUDIT_TRAIL_UPDATE)
            ) {
            ...
            LogEvent.logInfo(
                this.getClass().getSimpleName(),
                "saveHistory",
                "getChanges() returned XML length: " +
            ...
            if ((xml != null) && (xml.length() > 0)) {
                ...
                LogEvent.logInfo(
                    this.getClass().getSimpleName(),
                    "saveHistory",
                    "Created history record for table: " +
                        tableName +
                        ", referenceId: " +
                        referenceId +
                        ", activity: " +
                ...
                LogEvent.logInfo(
                    ...
                    "No changes detected for table: " +
                        ...
                        ", activity: " +
                        event +
                        " - skipping history record creation. XML was: " +
                        (xml != null ? "empty" : "null")
                );
            }
        } catch (RuntimeException e) {
            ...
            LogEvent.logError(e);
            throw new LIMSRuntimeException(
                "Error in AuditTrail saveHistory()",
                e
            );
        }
    }
    ...
    private String getChanges(
        ...
        fieldIteration: for (int ii = 0; ii < fields.length; ii++) {
            ...
            if (
                Modifier.isTransient(fields[ii].getModifiers()) ||
            ...
            if (
                ...
                String auditFunctionName =
                    "get" + StringUtil.capitalize(fieldName) + "_Audit";
                    ...
                    if (newObject != null) {
                        ...
                        if (objPropNewState != null) {
                            try {
                                ...
                                org.hibernate.LazyInitializationException e
                            ) {
                        ...
                        try {
                            ...
                            if (
                                ...
                                Method m2 = newObject
                                    .getClass()
                                    .getMethod(auditFunctionName, new Class[0]);
                                Object o2 = m2.invoke(
                                    newObject,
                                    (Object[]) new Class[0]
                                );
                            ...
                            LogEvent.logError(e);
                            throw new LIMSRuntimeException(
                                "Error in AuditTrail processLabelValue()",
                                e
                            );
                        }
                    } else {
                    ...
                    if (objPreUpdateState != null) {
                        try {
                            ...
                            LogEvent.logTrace(
                                ...
                                "Skipping field " +
                                    fieldName +
                                    " due to LazyInitializationException"
                            );
                            continue fieldIteration;
                        }
                    } else {
                ...
                if (fieldName.equals("qaEvent") || fieldName.equals("sample")) {
                    LabelValuePair lvb = processLabelValueFixes(
                        fieldName,
                        propertyPreUpdateState,
                        existingObject,
                        newObject
                    ...
                    if (propertyNewState.equals(propertyPreUpdateState)) {
                        ...
                        LogEvent.logInfo(
                            ...
                            "Field " +
                                fields[ii].getName() +
                                " values differ, processing change"
                        );
                        LabelValuePair lvb = processLabelValue(
                            fieldName,
                            propertyPreUpdateState,
                            existingObject,
                            newObject
                        ...
                        if (lvb != null) {
                            ...
                            LogEvent.logInfo(
                                this.getClass().getSimpleName(),
                                "getChanges",
                                "processLabelValue returned null for field: " +
                                    fields[ii].getName()
                            );
                        }
                    }
        ...
        LogEvent.logInfo(
            this.getClass().getSimpleName(),
            "getChanges",
            "Finished comparing fields. optionList size: " +
                optionList.size() +
                " for table: " +
                tableName
        );
        ...
        if (optionList.size() > 0) {
            ...
            LogEvent.logInfo(
                this.getClass().getSimpleName(),
                "getChanges",
                "No changes found, returning null XML"
            );
        }
    ...
    private LabelValuePair processLabelValueFixes(
        ...
        try {
            if (fieldName.equals("qaEvent")) {
                ...
                m1 = existingObject
                    .getClass()
                    .getMethod("getCompletedDate", new Class[0]);
            ...
            if (fieldName.equals("sample")) {
                ...
                try {
                    m1 = existingObject
                        .getClass()
                        .getMethod("getCollectionDate", new Class[0]);
                    o1 = m1.invoke(existingObject, (Object[]) new Class[0]);
            ...
            LogEvent.logError(e);
            throw new LIMSRuntimeException(
                "Error in AuditTrail processLabelValueFixes()",
                e
            );
        }
        ...
        if (
            ...
            ((propertyPreUpdateState != null) &&
                (propertyPreUpdateState.length() > 0))
        ) {
            if (
                propertyPreUpdateState.equals("{null}") ||
                propertyPreUpdateState.equals("null")
            ) {
    ...
    private LabelValuePair processLabelValue(
        ...
        if (
            ...
            if (fieldName.equals("test")) {
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getTest", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                    ...
                    if (o1 != null) {
                        Method m11 = o1
                            .getClass()
                            .getMethod("getStringId", new Class[0]);
                        oldID = (String) m11.invoke(
                            o1,
                            (Object[]) new Class[0]
                        );
                    }
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getTestSection", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getCounty", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getRegion", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getScriptlet", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getOrganization", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getPanel", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getPerson", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getTestResult", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getAnalysis", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getAnalyte", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getSampleItem", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getParentAnalysis", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getParentResult", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getSample", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getTestTrailer", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getUnitOfMeasure", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getTestAnalyte", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
                ...
                try {
                    Method m1 = existingObject
                        .getClass()
                        .getMethod("getLabel", new Class[0]);
                    Object o1 = m1.invoke(
                        existingObject,
                        (Object[]) new Class[0]
                    );
    ...
    @Override
    @Transactional(readOnly = true)
    public String getXMLData(String table, String id)
        throws LIMSRuntimeException {
        // StringBuffer xml;
        //
