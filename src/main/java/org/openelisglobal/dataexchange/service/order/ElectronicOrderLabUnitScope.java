...
public interface ElectronicOrderLabUnitScope {
     ...
     * Reception lab units, and those that cannot be tied to any OpenELIS test,
     * since nothing places such an order in a lab unit. A user holding every lab
     * unit gets the list back unchanged.
     */
