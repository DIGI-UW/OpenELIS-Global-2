...
public class RestStudyElectronicOrdersController extends BaseController {
    ...
    @RequestMapping(value = "/rest/rejectElectronicOrders", method = RequestMethod.GET)
    public ElectronicOrderViewForm rejectElectronicOrders(@ModelAttribute("form") @Valid ElectronicOrderViewForm form,
    ...
    public ElectronicOrderViewForm showElectronicOrders(@ModelAttribute("form") @Valid ElectronicOrderViewForm form,
            BindingResult result) {
