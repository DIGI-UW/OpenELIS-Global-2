...
public class SampleEntryByProjectRestController extends BaseSampleEntryRestController {
    ...
    @GetMapping(value = "/SampleEntryByProject", produces = MediaType.APPLICATION_JSON_VALUE)
