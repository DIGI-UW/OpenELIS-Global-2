...
public class SampleTbEntryRestController extends BaseSampleEntryRestController {
    ...
    @GetMapping(value = "/MicrobiologyTb", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostMapping(value = "/MicrobiologyTb", produces = MediaType.APPLICATION_JSON_VALUE)
