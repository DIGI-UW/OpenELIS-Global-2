 ...
 *
 * All queries use HQL for database portability and optimal caching.
 * Results are ordered by checked date/time descending for most recent first.
 */
@Component
@Transactional
...
public class LabEnvironmentalLogDAOImpl extends BaseDAOImpl<LabEnvironmentalLog, Long>
    ...
    public List<LabEnvironmentalLog> findByStorageUnitType(LabEnvironmentalLog.StorageUnitType storageUnitType) {
        String sql = "SELECT * FROM clinlims.lab_environmental_log " +
        ...
        List<LabEnvironmentalLog> results = entityManager.createNativeQuery(sql, LabEnvironmentalLog.class)
                .setParameter("storageUnitType", storageUnitType.name())
                .getResultList();
        return results;
    }
    ...
    @Override
    public List<LabEnvironmentalLog> findByStorageUnitIdAndDateRange(
    ...
    @Override
    public List<LabEnvironmentalLog> findOutOfRangeTemperature(
            LabEnvironmentalLog.StorageUnitType storageUnitType,
            Double minTemp,
            Double maxTemp) {
        String sql = "SELECT * FROM clinlims.lab_environmental_log " +
    ...
    @Override
    public long countOutOfRangeTemperature(
            LabEnvironmentalLog.StorageUnitType storageUnitType,
            Double minTemp,
            Double maxTemp) {
        String sql = "SELECT COUNT(*) FROM clinlims.lab_environmental_log " +
