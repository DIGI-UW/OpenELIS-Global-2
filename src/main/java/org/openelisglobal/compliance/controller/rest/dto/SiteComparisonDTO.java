...
public class SiteComparisonDTO {
    ...
    public enum ColorBand { GREEN, YELLOW, RED }
    ...
    public int getExceedances() { return exceedances; }
    public void setExceedances(int v) { exceedances = v; }
    public ColorBand getColorBand() { return colorBand; }
    public void setColorBand(ColorBand v) { colorBand = v; }
}
