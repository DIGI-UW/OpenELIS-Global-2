...
public class SampleTypeDisplay {
    ...
    public SampleTypeDisplay(String id, String description, String localAbbreviation, String sortOrder,
            boolean isActive, String domain, String whonetCode, int testCount, String storageDefaults) {
        this.id = id;
