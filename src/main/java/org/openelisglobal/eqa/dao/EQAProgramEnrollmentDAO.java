...
public interface EQAProgramEnrollmentDAO extends BaseDAO<EQAProgramEnrollment, Long> {
     ...
     * grouped query. "Provides" means at least one other laboratory is actively
     * enrolled — OpenELIS is single-tenant, so that enrollment is what
     ...
     * Replaces the earlier walk over every cycle asking each scheme for its count.
     */
