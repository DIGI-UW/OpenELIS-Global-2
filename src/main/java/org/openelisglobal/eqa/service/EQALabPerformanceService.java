...
/**
 * Lab EQA Performance (OGC-611): the accreditation snapshot this lab's quality
 * manager reads — twelve-month KPIs, per-section coverage across each scheme's
 * last four cycles, and the cycles behind them.
 *
 * <p>
