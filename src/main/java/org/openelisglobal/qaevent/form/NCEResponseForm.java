...
/**
 * Form class for NCE creation responses. Maps to the NCEResponse schema in the
...
public class NCEResponseForm {
    ...
    public NCEResponseForm(String id, String nceNumber, String status, String createdDate,
            List<String> associatedResults) {
        this.id = id;
    ...
    public String toString() {
        return "NCEResponseForm{" + "id=" + id + ", nceNumber='" + nceNumber + '\'' + ", status='" + status + '\''
                + ", createdDate='" + createdDate + '\'' + ", associatedResults=" + associatedResults + '}';
    }
}