...
/**
 * Entity class for linking lab results to Non-Conformity Events (NCEs).
 * This association tracks the relationship between specific lab results
 * and quality issues reported through the NCE system.
 */
@Entity
...
public class NceResultAssociation extends BaseObject<Integer> {
    ...
    public NceResultAssociation(Result result, NcEvent ncEvent, AssociationType type, String createdBy) {
        this();
        this.result = result;
    ...
    public String toString() {
        return "NceResultAssociation{" +
                "id=" + id +
                ", resultId=" + (result != null ? result.getId() : null) +
                ", nceId=" + (ncEvent != null ? ncEvent.getId() : null) +
