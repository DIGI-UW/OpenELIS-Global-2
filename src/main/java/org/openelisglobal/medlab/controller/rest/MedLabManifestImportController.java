...
public class MedLabManifestImportController extends BaseRestController {
    ...
    public ResponseEntity<Map<String, Object>> previewManifest(@RequestParam("file") MultipartFile file,
            ...
            @RequestParam(value = "collectionDateColumn", required = false) String collectionDateColumn,
            @RequestParam(value = "collectionTimeColumn", required = false) String collectionTimeColumn,
