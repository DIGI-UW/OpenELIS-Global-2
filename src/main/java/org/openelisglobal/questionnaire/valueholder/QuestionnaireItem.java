...
public class QuestionnaireItem extends BaseObject<String> {

    @Id
    @Column(name = "ID", precision = 10, scale = 0)
    @GeneratedValue(generator = "questionnaire_item_seq_gen")
    @GenericGenerator(name = "questionnaire_item_seq_gen", strategy = "org.openelisglobal.hibernate.resources.StringSequenceGenerator", parameters = @Parameter(name = "sequence_name", value = "questionnaire_item_seq"))
