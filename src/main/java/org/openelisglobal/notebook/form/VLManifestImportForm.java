...
/**
 * Form class for VL (Virology Laboratory) manifest CSV column
 * mapping configuration.
 *
 * Allows mapping of CSV column names to VL-specific fields during manifest
 ...
 */
public class VLManifestImportForm {
