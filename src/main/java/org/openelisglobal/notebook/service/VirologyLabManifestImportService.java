...
/**
 * Service interface for VirologyLab (Virology Laboratory) manifest CSV import
 * operations.
 *
 * Handles parsing, validation, and import of virology sample metadata from CSV
 * manifests. Supports the complete VirologyLab workflow including sample
 * reception, processing, and quality control tracking.
 */
public interface VirologyLabManifestImportService {
     ...
     */
    VirologyLabManifestImportResult createSamplesForEntry(Integer entryId, ParsedManifest parsedManifest,
            String sysUserId);

    /**
     * Represents a single row from the parsed CSV manifest.
     */
    record ManifestRow(int rowNumber, String sampleId, String sampleType, String source, String collectionDate,
            String receptionDateTime, String projectStudyAssociation, String volumeConcentration, String a260_280,
            String a260_230, String rin, String extractionMethodKit, String pcrProtocol, String libraryPrepProtocol,
            String sequencingPlatform, String runId, String operator, String processingDateTime, String notes) {
    }
     ...
     */
    record VirologyLabManifestImportResult(int totalRequested, int totalCreated, List<String> createdSampleIds,
