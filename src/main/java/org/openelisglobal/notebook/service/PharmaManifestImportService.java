...
/**
 * Service interface for Pharmaceuticals manifest CSV import.
...
public interface PharmaManifestImportService {
    ...
    /**
     * Represents a single row from the pharmaceutical manifest CSV.
     * Each row creates one sample with its associated metadata.
     */
    record PharmaManifestRow(
            int rowNumber,
            // Required fields
            String sampleName,
            String lotBatchNumber,
            String dateOfManufacture,
            String expiryRetestDate,
            String storageCondition,
            String ownerRequester,
            // Sample type (validated against Pharmaceutical lab types)
            String sampleType,
            // Optional fields
            String alphanumericCode,
            String chemicalIupacName,
            String gradeSpecification,
            String chainOfCustodyDetails,
            String patientId,
