 ...
 */
@RestController
@RequestMapping("/rest/notebook/virologylab")
public class VirologyLabManifestImportController extends BaseRestController {

    @Autowired
    private VirologyLabManifestImportService virologyLabManifestImportService;
     ...
     * @return Paginated list of valid sample types (DNA, RNA, cDNA, virology
     *         materials)
     */
    ...
    public ResponseEntity<Map<String, Object>> getValidSampleTypes(
        ...
        List<Map<String, String>> allSampleTypes = virologyLabManifestImportService.getValidVirologyLabSampleTypes();
    ...
    public ResponseEntity<Map<String, Object>> previewManifestForEntry(@PathVariable("entryId") Integer entryId,
            @RequestPart("file") MultipartFile file, @RequestPart("mapping") VirologyLabManifestImportForm form) {
        ...
        try (InputStream inputStream = file.getInputStream()) {
            ParsedManifest parsed = virologyLabManifestImportService.parseManifestCsv(inputStream, form);
            List<ParseError> validationErrors = virologyLabManifestImportService.validateManifest(parsed);
