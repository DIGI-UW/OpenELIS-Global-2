...
public class UserServiceImpl implements UserService {
    ...
    public List<IdValuePair> getUserSampleTypes(String systemUserId, String roleName) {
        ...
        // Also include all active clinical sample types even if they don't have tests
        // associated yet
        // This ensures newly created clinical sample types appear in order entry
        // dropdowns
        List<TypeOfSample> allActiveClinicalSampleTypes = typeOfSampleService
                .getTypesForDomainBySortOrder(org.openelisglobal.typeofsample.dao.TypeOfSampleDAO.SampleDomain.HUMAN);
        if (allActiveClinicalSampleTypes != null) {
            allActiveClinicalSampleTypes.stream().filter(type -> type.getIsActive()) // Only active sample types
