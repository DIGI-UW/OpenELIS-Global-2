 ...
 * Handles validation and execution of sample advancement through the virology workflow.
 */
public interface VirologyProgressionService {
     ...
     * @param fromStage The current stage (stage1_reception, stage2_culture, stage3_vaccine)
     ...
     */
    ProgressionResult advanceSamples(Long entryId, String fromStage, String toStage, List<Long> sampleIds, String userId);
