...
/**
 * Process Step 2: Sterilization
 * Record sterilization parameters (temp, time, pressure)
 */
@Entity
...
public class VirusCultureSterilization extends BaseObject<Integer> {
    ...
    public SterilizationMethod getSterilizationMethod() { return sterilizationMethod; }
    public void setSterilizationMethod(SterilizationMethod sterilizationMethod) { this.sterilizationMethod = sterilizationMethod; }
    ...
    public void setCycleNumber(String cycleNumber) { this.cycleNumber = cycleNumber; }
    ...
    public String getSporeTestResult() { return sporeTestResult; }
    public void setSporeTestResult(String sporeTestResult) { this.sporeTestResult = sporeTestResult; }
    ...
    public SystemUser getValidatedBy() { return validatedBy; }
    public void setValidatedBy(SystemUser validatedBy) { this.validatedBy = validatedBy; }

    public Timestamp getSterilizationDate() { return sterilizationDate; }
    public void setSterilizationDate(Timestamp sterilizationDate) { this.sterilizationDate = sterilizationDate; }

    public String getNotes() { return notes; }
    public void setNotes(String notes) { this.notes = notes; }

    public boolean isValidated() { return validationResult == ValidationResult.PASSED; }
    public boolean hasFailed() { return validationResult == ValidationResult.FAILED; }
}