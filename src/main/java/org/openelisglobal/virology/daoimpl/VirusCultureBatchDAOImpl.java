...
public class VirusCultureBatchDAOImpl extends BaseDAOImpl<VirusCultureBatch, Integer> implements VirusCultureBatchDAO {
    ...
    public VirusCultureBatch findByBatchId(String batchId) {
        ...
        Query<VirusCultureBatch> query = entityManager.unwrap(Session.class).createQuery(hql, VirusCultureBatch.class);
    ...
    public List<VirusCultureBatch> findActiveBatches() {
        String hql = """
                ...
                """;
        Query<VirusCultureBatch> query = entityManager.unwrap(Session.class).createQuery(hql, VirusCultureBatch.class);
        query.setParameter("completedStatuses", List.of(VirusCultureBatch.BatchStatus.WORKFLOW_COMPLETE,
                VirusCultureBatch.BatchStatus.FAILED, VirusCultureBatch.BatchStatus.CANCELLED));
    ...
    public List<VirusCultureBatch> findBatchesRequiringAttention() {
        String hql = """
                ...
                """;
        Query<VirusCultureBatch> query = entityManager.unwrap(Session.class).createQuery(hql, VirusCultureBatch.class);
        query.setParameter("attentionStatuses", List.of(VirusCultureBatch.BatchStatus.FAILED));
