...
public class ObservationHistoryServiceImpl extends AuditableBaseObjectServiceImpl<ObservationHistory, String>
    ...
    public enum ObservationType {
        ...
        VS_POOLING_METHOD("vecPoolingMethod"), VS_POOL_COUNT("vecPoolCount"), VS_SAMPLES_PER_POOL("vecSamplesPerPool"),
        ...
        VS_GPS_LONGITUDE("vecGpsLongitude"), VS_TIME_OF_DAY("vecTimeOfDay"), VS_RESTING_CONTEXT("vecRestingContext"),
        VS_HUMAN_BITING_CATCH("vecHumanBitingCatch"), VS_COLLECTION_NOTES("vecCollectionNotes");
