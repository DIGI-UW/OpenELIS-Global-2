...
@Service
public class PatientPhotoServiceImpl extends AuditableBaseObjectServiceImpl<PatientPhoto, Integer> implements PatientPhotoService {
 ...
 private String createThumbnail(String base64Data)  {
      ...
      public String getPhotoByPatientId(String patientId, boolean isThumbnail) {
        ...
        if (!isThumbnail) {
            return photo != null ? "data:"+photo.getPhotoType()+";base64," + photo.getThumbnailData() : null;
        }
