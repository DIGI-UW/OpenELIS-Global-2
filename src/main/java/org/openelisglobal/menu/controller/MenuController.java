...
public class MenuController {
    ...
    public List<MenuItem> getMenuTreeByView(@RequestParam(value = "view", required = false) String view) {
        return "react".equals(view) ? MenuUtil.getMenuTreeForReactUI() : MenuUtil.getMenuTree();
    }
