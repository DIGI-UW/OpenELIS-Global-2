...
/**
 * Service responsible for seeding menu entries from a configuration file at
...
public class MenuSeedService {
    ...
    public void seedMenusFromConfig() {
        ...
        try {
            ...
            LogEvent.logError("MenuSeedService", "seedMenusFromConfig",
    ...
    private int seedMenus(List<MenuItemDTO> menuItemDTOs, Menu parentMenu) {
        ...
        for (MenuItemDTO dto : menuItemDTOs) {
            if (GenericValidator.isBlankOrNull(dto.getElementId())) {
                LogEvent.logWarn("MenuSeedService", "seedMenus", "Skipping menu with missing elementId");
                continue;
            }
            ...
            try {
                ...
                if (existingMenu != null) {
                    LogEvent.logDebug("MenuSeedService", "seedMenus",
                ...
                LogEvent.logInfo("MenuSeedService", "seedMenus", "Created menu: " + dto.getElementId() + " (parent: "
                ...
                LogEvent.logError("MenuSeedService", "seedMenus",
