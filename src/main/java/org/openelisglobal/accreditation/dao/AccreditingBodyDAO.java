...
public interface AccreditingBodyDAO extends BaseDAO<AccreditingBody, Long> {
    AccreditingBody findByCode(String code);

    List<AccreditingBody> findAllActive();

    List<AccreditingBody> findAllOrderedByDisplayOrder();

    long countTestAccreditationsByBodyId(Long accreditingBodyId);
}
