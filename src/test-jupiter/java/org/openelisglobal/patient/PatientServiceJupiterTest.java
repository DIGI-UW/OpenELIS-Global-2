...
import org.openelisglobal.BaseWebContextSensitiveJupiterTests;
...
public class PatientServiceJupiterTest extends BaseWebContextSensitiveJupiterTests {
    ...
    public void init() throws Exception {
        executeDataSetWithStateManagement("testdata/patient-jupiter.xml");
    }
    ...
    public void createPatient_shouldCreateNewPatient() throws Exception {
        ...
        assertEquals(firstName, savedPatient.getPerson().getFirstName());
        assertEquals(lastname, savedPatient.getPerson().getLastName());
        assertEquals(gender, savedPatient.getGender());
    }
    ...
    public void getSubjectNumber_shouldReturnSubjectNumber() {
        ...
        assertEquals("334-422-A", patientService.getSubjectNumber(patient));
    }
    ...
    public void getIdentityList_shouldReturnIdentityList() {
        ...
        assertEquals(17, patientService.getIdentityList(patient).size());
    }
    ...
    public void getNationality_shouldReturnNationality() {
        ...
        assertEquals("Ugandan", patientService.getNationality(patient));
    }
    ...
    public void getOtherNationality_shouldReturnOtherNationality() {
        ...
        assertEquals("USA", patientService.getOtherNationality(patient));
    }
    ...
    public void getMother_shouldReturnMother() {
        ...
        assertEquals("Jackie Moore", patientService.getMother(patient));
    }
    ...
    public void getMothersInitial_shouldReturnMothersInitial() {
        ...
        assertEquals("JM", patientService.getMothersInitial(patient));
    }
    ...
    public void getInsurance_shouldReturnInsurance() {
        ...
        assertEquals("US119a36", patientService.getInsurance(patient));
    }
    ...
    public void getOccupation_shouldReturnOccupation() {
        ...
        assertEquals("Truck Driver", patientService.getOccupation(patient));
    }
    ...
    public void getOrgSite_shouldReturnOrgSite() {
        ...
        assertEquals("orgSite", patientService.getOrgSite(patient));
    }
    ...
    public void getEducation_shouldReturnEducationQualification() {
        ...
        assertEquals("MBA Certificate", patientService.getEducation(patient));
    }
    ...
    public void getHealthDistrict_shouldReturnHealthDistrict() {
        ...
        assertEquals("Jinja", patientService.getHealthDistrict(patient));
    }
    ...
    public void getHealthRegion_shouldReturnHealthRegion() {
        ...
        assertEquals("EastAfrica", patientService.getHealthRegion(patient));
    }
    ...
    public void getMaritalStatus_shouldReturnMaritalStatus() {
        ...
        assertEquals("Married", patientService.getMaritalStatus(patient));
    }
    ...
    public void getObNumber_shouldReturngObNumber() {
        ...
        assertEquals("1234", patientService.getObNumber(patient));
    }
    ...
    public void getPCNumber_shouldReturngPCNumber() {
        ...
        assertEquals("124", patientService.getPCNumber(patient));
    }
    ...
    public void getSTNumber_shouldReturngSTNumber() {
        ...
        assertEquals("123", patientService.getSTNumber(patient));
    }
    ...
    public void getAKA_shouldReturnAKA() {
        ...
        assertEquals("BigMan", patientService.getAKA(patient));
    }
    ...
    public void getGUID_shouldReturnGUID() {
        ...
        assertEquals("EA400A1", patientService.getGUID(patient));
    }

    @Test
    public void getGUID_shouldReturnEmptyStringForNullPatient() {
        assertEquals("", patientService.getGUID(null));
    }
    ...
    public void getGUID_shouldReturnEmptyStringForNullPatientWithNoGUID() {
        ...
        assertEquals("", patientService.getGUID(patient));
    }
    ...
    public void getData_shouldCopyPropertiesFromDatabaseById() {
        ...
        assertEquals(firstName, patient2.getPerson().getFirstName());
        assertEquals(lastname, patient2.getPerson().getLastName());
        assertEquals(gender, patient2.getGender());
    }

    @Test
    public void getEnteredDOB_shouldReturnEnteredDOB() {
        Patient patient = patientService.get("1");
        assertEquals("1992-12-12", patientService.getEnteredDOB(patient));
    }
    ...
    public void getDOB_shouldReturnDOB() throws Exception {
        ...
        assertEquals("1992-12-12 00:00:00.0", patientService.getDOB(patient).toString());
    }

    @Test
    public void getPhone_shouldReturnPhone() {
        Patient patient = patientService.get("1");
        assertEquals("12345678", patientService.getPhone(patient));
    }
    ...
    public void getPatientId_shouldReturngPatientId() {
        ...
        assertEquals("1", patientService.getPatientId(patient));
    }
    ...
    public void getAllMissingFhirUuid_shouldGetAllPatientsMissingFhirUuid() throws Exception {
        ...
        assertEquals("2", patients.get(0).getId(), "The first element should be 2");
        assertEquals("3", patients.get(1).getId(), "The first element should be 3");
    }
    ...
    public void getByExternalId_shouldGetAllPatients() throws Exception {
        ...
        String lastname = "Doe";
        String gender = "M";
        assertEquals(firstName, patientService.getByExternalId("EX456").getPerson().getFirstName());
        assertEquals(lastname, patientService.getByExternalId("EX456").getPerson().getLastName());
        assertEquals(gender, patientService.getByExternalId("EX456").getGender());
    }
    ...
    public void updatePatient_shouldUpdateExistingPatient() {
        ...
        assertEquals("Alicia", updatedPatient.getPerson().getFirstName());
    ...
    public void createPatientType_shouldCreateNewPatientType() throws SQLException, DatabaseUnitException {
        ...
        assertEquals(0, patientTypeService.getAllPatientTypes().size());
        ...
        assertEquals(1, patientTypeService.getAllPatientTypes().size());
    ...
    public void getNationalId_shouldReturnNationalId() throws Exception {
        ...
        assertEquals("1234", patientService.getNationalId(pat));
    }
    ...
    public void getPatientByNationalId_shouldReturnCorrectPatient() {
        ...
        assertEquals("1", fetchedPatient.getId());
    }
    ...
    public void getPatientsByNationalId_shouldReturnListOfPatients() {
        ...
        assertEquals(1, fetchedPatients.size());
    }
    ...
    public void getPatientByExternalId_shouldReturnCorrectPatient() {
        ...
        assertNotNull(fetchedPatient);
        assertEquals("Faith", fetchedPatient.getPerson().getFirstName());
        assertEquals("F", fetchedPatient.getGender());
    }

    @Test
    public void externalIDExists_shouldReturnExternalIDExists() {

        assertTrue(patientService.externalIDExists("EX123"));
    }
    ...
    public void getExternalID_shouldReturnExternalID() {
        ...
        assertEquals("EX123", patientService.getExternalId(pat));
    }
    ...
    public void readPatient_shouldReadPatient() {
        ...
        assertEquals(firstName, patient.getPerson().getFirstName());
        assertEquals(lastname, patient.getPerson().getLastName());
        assertEquals(gender, patient.getGender());
    }
    ...
    public void getFirstName_shouldReturnCorrectFirstName() {
        ...
        assertEquals(firstName, fetchedFirstName);
    }
    ...
    public void getLastName_shouldReturnCorrectLastName() {
        ...
        assertEquals(lastName, fetchedLastName);
    }
    ...
    public void getLastFirstName_shouldReturnCorrectLastFirstName() {
        ...
        assertEquals(lastName + ", " + firstName, lastFirstName);
    }
    ...
    public void getGender_shouldReturnCorrectGender() {
        ...
        assertEquals(gender, fetchedGender);
    }
    ...
    public void getLocalizedGender_shouldReturnCorrectLocalizedGender() {
        ...
        assertEquals("MALE", localizedGender.toUpperCase());
    }
    ...
    public void getBirthdayForDisplay_shouldReturnBirthdayForDisplay() throws Exception {
        ...
        assertEquals(dob, patientService.getBirthdayForDisplay(pat).toString());
    }
    ...
    public void getPageOfPatients_shouldReturnCorrectPatients() {
        ...
        assertTrue(patientsPage.size() <= expectedPageSize);

        if (expectedPageSize >= 3) {
            assertTrue(patientsPage.stream().anyMatch(p -> p.getPerson().getFirstName().equals(firstName1)));
            assertTrue(patientsPage.stream().anyMatch(p -> p.getPerson().getFirstName().equals(firstName2)));
        }
    }
