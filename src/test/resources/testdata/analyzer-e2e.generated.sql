...
INSERT INTO analyzer_test_map (analyzer_type_id, analyzer_id, analyzer_test_name, test_id, last_updated) VALUES (2901, 2013, 'MTB-RIF', 175, '2026-02-02 00:00:00') ON CONFLICT DO NOTHING;
INSERT INTO analyzer_test_map (analyzer_type_id, analyzer_id, analyzer_test_name, test_id, last_updated) VALUES (2901, 2013, 'RIF', 38, '2026-02-02 00:00:00') ON CONFLICT DO NOTHING;
INSERT INTO analyzer_test_map (analyzer_type_id, analyzer_id, analyzer_test_name, test_id, last_updated) VALUES (2901, 2013, 'HIV-VL', 313, '2026-02-02 00:00:00') ON CONFLICT DO NOTHING;
INSERT INTO analyzer_test_map (analyzer_type_id, analyzer_id, analyzer_test_name, test_id, last_updated) VALUES (2901, 2013, 'COVID19', 300, '2026-02-02 00:00:00') ON CONFLICT DO NOTHING;
