 ...
 * 
 * This test validates that all Hibernate/JPA annotations are correctly
 * configured and can build a SessionFactory without errors. It catches: -
 * Getter/setter conflicts (e.g., getActive() vs isActive()) - Property name
 * mismatches - Missing annotations - Invalid relationship mappings
 * 
