    ...
    public void setDefaultTestAuthentication() {
        SecurityContextHolder.getContext().setAuthentication(new UsernamePasswordAuthenticationToken("admin", "N/A",
                List.of(new SimpleGrantedAuthority("ROLE_ADMIN"), new SimpleGrantedAuthority("ROLE_RESULTS"),
                        ...
                        new SimpleGrantedAuthority("PRIV_ANALYZER_CONFIGURE"), new SimpleGrantedAuthority("PRIV_ANALYZER_IMPORT"),
                        ...
                        new SimpleGrantedAuthority("PRIV_COLDSTORAGE_MANAGE"), new SimpleGrantedAuthority("PRIV_COLDSTORAGE_VIEW"),
                        new SimpleGrantedAuthority("PRIV_DICTIONARY_MANAGE"), new SimpleGrantedAuthority("PRIV_DICTIONARY_VIEW"),
                        ...
                        new SimpleGrantedAuthority("PRIV_EXTCONNECTION_MANAGE"), new SimpleGrantedAuthority("PRIV_EXTCONNECTION_VIEW"),
                        new SimpleGrantedAuthority("PRIV_INVENTORY_MANAGE"), new SimpleGrantedAuthority("PRIV_INVENTORY_VIEW"),
                        new SimpleGrantedAuthority("PRIV_LOCALIZATION_MANAGE"), new SimpleGrantedAuthority("PRIV_LOCALIZATION_VIEW"),
                        new SimpleGrantedAuthority("PRIV_METHOD_VIEW"),
                        new SimpleGrantedAuthority("PRIV_NCE_CREATE"), new SimpleGrantedAuthority("PRIV_NCE_EDIT"), new SimpleGrantedAuthority("PRIV_NCE_VIEW"),
                        new SimpleGrantedAuthority("PRIV_NOTEBOOK_MANAGE"), new SimpleGrantedAuthority("PRIV_NOTEBOOK_VIEW"),
                        new SimpleGrantedAuthority("PRIV_NOTIFICATION_MANAGE"), new SimpleGrantedAuthority("PRIV_NOTIFICATION_VIEW"),
                        new SimpleGrantedAuthority("PRIV_ORDER_CREATE"), new SimpleGrantedAuthority("PRIV_ORDER_EDIT"), new SimpleGrantedAuthority("PRIV_ORDER_VIEW"),
                        new SimpleGrantedAuthority("PRIV_ORGANIZATION_MANAGE"), new SimpleGrantedAuthority("PRIV_ORGANIZATION_VIEW"),
                        new SimpleGrantedAuthority("PRIV_PANEL_MANAGE"),
                        new SimpleGrantedAuthority("PRIV_PATIENT_MANAGE"), new SimpleGrantedAuthority("PRIV_PATIENT_VIEW"),
                        new SimpleGrantedAuthority("PRIV_RESULT_ENTER"), new SimpleGrantedAuthority("PRIV_RESULT_VALIDATE"), new SimpleGrantedAuthority("PRIV_RESULT_VIEW"),
                        new SimpleGrantedAuthority("PRIV_ROLE_MANAGE"), new SimpleGrantedAuthority("PRIV_ROLE_VIEW"),
                        new SimpleGrantedAuthority("PRIV_SAMPLE_REQUESTER_VIEW"), new SimpleGrantedAuthority("PRIV_SAMPLE_STATUS_VIEW"),
                        ...
                        new SimpleGrantedAuthority("PRIV_STORAGE_MANAGE"), new SimpleGrantedAuthority("PRIV_STORAGE_VIEW"),
                        new SimpleGrantedAuthority("PRIV_SYSTEM_CONFIGURE"),
                        new SimpleGrantedAuthority("PRIV_SYSTEM_USER_MANAGE"), new SimpleGrantedAuthority("PRIV_SYSTEM_USER_VIEW"),
                        new SimpleGrantedAuthority("PRIV_TESTCALC_VIEW"), new SimpleGrantedAuthority("PRIV_TEST_CONFIGURE"),
