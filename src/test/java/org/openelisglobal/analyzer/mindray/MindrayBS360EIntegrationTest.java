...
public class MindrayBS360EIntegrationTest extends BaseWebContextSensitiveTest {
    ...
    private void createMindrayAnalyzerAndConfig() {
        ...
        analyzerConfigurationService.createConfiguration(mindrayAnalyzer, "192.168.1.101", 2575,
    ...
    public void mindrayBs360eHl7Message_resultsStored() throws Exception {
        String raw = loadFixture("testdata/hl7/mindray/bs360e-chemistry-result.hl7");
