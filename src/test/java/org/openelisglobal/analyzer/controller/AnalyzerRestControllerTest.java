...
// Note: AnalyzerForm and AnalyzerConfigurationService will be created in Phase 3 implementation
// For now, we test the controller endpoints exist
...
/**
 * Integration tests for AnalyzerRestController
...
public class AnalyzerRestControllerTest extends BaseWebContextSensitiveTest {
    ...
    public void testCreateAnalyzer_WithValidData_ReturnsCreated() throws Exception {
        ...
        mockMvc.perform(post("/rest/analyzer/analyzers")
                .contentType(MediaType.APPLICATION_JSON)
                .content(requestBody))
    ...
    public void testGetAnalyzer_WithValidId_ReturnsAnalyzer() throws Exception {
        ...
        mockMvc.perform(get("/rest/analyzer/analyzers/" + analyzerId)
                .contentType(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.id").value(analyzerId))
            .andExpect(jsonPath("$.name").value(uniqueName));
    }
    ...
    public void testGetAnalyzer_WithInvalidId_ReturnsNotFound() throws Exception {
        // Act & Assert
        mockMvc.perform(get("/rest/analyzer/analyzers/99999")
                .contentType(MediaType.APPLICATION_JSON))
    ...
    public void testUpdateAnalyzer_WithValidData_ReturnsUpdated() throws Exception {
        ...
        mockMvc.perform(put("/rest/analyzer/analyzers/" + analyzerId)
                .contentType(MediaType.APPLICATION_JSON)
                .content(updateBody))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.id").value(analyzerId))
    ...
    /**
     * Test: DELETE /rest/analyzer/analyzers/{id} soft deletes analyzer
     * Task Reference: T054
     */
    @Test
    public void testDeleteAnalyzer_WithValidId_ReturnsNoContent() throws Exception {
        ...
        mockMvc.perform(delete("/rest/analyzer/analyzers/" + analyzerId)
                .contentType(MediaType.APPLICATION_JSON))
