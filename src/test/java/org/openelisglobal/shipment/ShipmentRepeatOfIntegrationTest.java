...
/**
 * OGC-613 [EQA V2.5] — shipment.repeat_of_shipment_id: the reprovisioning trail
 * persists, and deleting an original that a repeat still points at is refused
 * (RESTRICT), so the register cannot lose its history.
 */
