...
public class BarcodeInformationServiceTest extends BaseWebContextSensitiveTest {
        ...
        public void updateBarcodeInfoFromForm() {
                ...
                SiteInformation heightSiteInformation = siteInformationService
                ...
                SiteInformation widthSiteInformation = siteInformationService
                ...
                assertTrue(updatedSiteInformationList.stream()
                                .anyMatch(si -> "heightOrderLabels".equals(si.getName())));
                ...
                assertTrue(updatedSiteInformationList.stream()
                                .anyMatch(si -> "numMaxSpecimenLabels".equals(si.getName())));
