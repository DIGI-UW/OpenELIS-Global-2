...
public class MicroCaseInoculationRestControllerTest {
    ...
    public void recordUsesAuthenticatedActorAndReturnsCreatedRecord() {
        ...
        when(service.record(eq("case-1"), eq(null), eq("BOTTLE-001"), eq("Blood agar"), eq(null), eq(null), eq("42")))
                .thenReturn(inoculation);
        ...
        verify(service).record("case-1", null, "BOTTLE-001", "Blood agar", null, null, "42");
    }
