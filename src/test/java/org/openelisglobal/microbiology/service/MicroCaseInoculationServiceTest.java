...
public class MicroCaseInoculationServiceTest {
    ...
    @Before
    public void setUp() {
        service = new MicroCaseInoculationServiceImpl(caseDAO, inoculationDAO, activityDAO, new ObjectMapper());
    ...
    @Test
    public void recordsPrimaryInoculationTimelineAndStageAtomically() throws Exception {
    ...
    public void rejectsSubcultureParentFromAnotherCase() {
        ...
        service.record("case-1", "inoculation-2", "PLATE-002", "MacConkey agar", null, null, "42");
    }
    ...
    public void rejectsInoculationBeforeWorkflowClassification() {
        ...
        service.record("case-1", null, "BOTTLE-001", "Blood agar", null, null, "42");
    }
