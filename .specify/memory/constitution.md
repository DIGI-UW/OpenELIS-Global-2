...
- Schema migrations in `src/main/resources/liquibase/{version}/` (e.g., `3.3.x.x/`)
- Changesets MUST have unique IDs: `{sequence}-{description}` (e.g., `023-storage-device-connectivity`)
- All changesets MUST be placed inside versioned folders - NO module-specific folders outside version directories
