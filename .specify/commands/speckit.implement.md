...
6. Execute implementation following the task plan:
   ...
   - **Follow TDD approach (MANDATORY)**: 
     ...
     - Use test templates from `.specify/templates/testing/` when generating test code
     - Reference Testing Roadmap (`.specify/guides/testing-roadmap.md`) for patterns
     - At checkpoint validations: Tests MUST pass before proceeding to next phase
