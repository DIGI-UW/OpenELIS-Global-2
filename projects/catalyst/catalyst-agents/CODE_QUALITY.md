...
**What:** Ultra-fast linter and formatter (replaces Black, Flake8, isort, and more)
**Why:** 10-100x faster than traditional tools, with 800+ built-in rules
...
**What:** Git hook framework that runs checks before commits
**Why:** Automatically enforces code quality standards
