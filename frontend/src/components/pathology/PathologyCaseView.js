    ...
    <div className="app-shell">
      ...
      <div className="sticky-header">
          <PageBreadCrumb breadcrumbs={breadcrumbs} />
            <Grid fullWidth={true}>
              <Column lg={16}>
                <PatientHeaderReDesign 
                  id={"pathology.label.title"}
                  patient={`${pathologySampleInfo.lastName}, ${pathologySampleInfo.firstName}`}
                  dob={pathologySampleInfo.age}
                  gender={pathologySampleInfo.sex}
                  processing={pathologySampleInfo.department}
                />
              </Column>
            </Grid>
