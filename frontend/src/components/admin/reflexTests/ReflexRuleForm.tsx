...
type TestResultList = Record<
  number,
  Record<number, { type: string; list: Array<{ id: string; value: string }> }>
>;
...
function ReflexRule() {
  ...
  const [testResultList, setTestResultList] = useState<TestResultList>({
    0: { 0: { type: "N", list: [] } },
                                ...
                                >
                                  {rule.conditions.length !== 1 && (
                                    <IconButton
                                      ...
                                      // @ts-expect-error -- preserve the original legacy Carbon kind
                                      kind="danger"
                                      size="sm"
                                    >
                                      {" "}
