...
interface PendingAnalysisResponse {
  notStarted?: PendingAnalysis[];
  technicianRejection?: PendingAnalysis[];
  biologistRejection?: PendingAnalysis[];
  notValidated?: PendingAnalysis[];
}
...
function BatchTestReassignmentAndCancelation() {
  ...
  const [sampleTypeToGetIdData, setSampleTypeToGetIdData] =
    useState<TestListResponse>({});
  const [sampleTypeToGetIdDataTag, setSampleTypeToGetIdDataTag] =
    useState<TestListResponse>({});
  ...
  const [
    ...
    setSampleTypeTestIdToGetIdPendingData,
  ] = useState<PendingAnalysisResponse>({});
              ...
              <Select
                ...
                defaultValue={
                  sampleTypeToGetIdData && sampleTypeToGetIdData.tests
                    ? (sampleTypeToGetIdData.tests[0] as unknown as string)
                    : ""
                }
              ...
              <Select
                ...
                defaultValue={
                  sampleTypeToGetIdDataTag && sampleTypeToGetIdDataTag.tests
                    ? (sampleTypeToGetIdDataTag.tests[0] as unknown as string)
                    : ""
                }
