...
function SampleTypeBulkImport() {
      ...
      (res) => {
        ...
        if (res && res.success) {
          ...
          addNotification({
            ...
            title: intl.formatMessage({ id: "notification.title" }),
            message:
              res?.message || "Import failed. Please check your file format.",
          });
          setNotificationVisible(true);
        }
  ...
  const downloadTemplate = () => {
    const csvContent =
      "Name,Description,Display Order,WHONET Code,Storage Defaults,Active\n" +
  ...
  const rows = [
    {
      ...
      description:
        "Upload a CSV file with sample type data. Required columns: Name, Description, Display Order, WHONET Code, Storage Defaults, Active.",
    },
    {
      id: "preview",
      field: "Preview",
      description:
        "Review the data before importing. The first 5 rows will be shown for verification.",
    },
  ];
  ...
  const headers = [
    ...
    {
      key: "description",
      header: intl.formatMessage({ id: "sample.type.description" }),
    },
    {
      key: "displayOrder",
      header: intl.formatMessage({ id: "sample.type.display.order" }),
    },
    {
      key: "whonetCode",
      header: intl.formatMessage({ id: "sample.type.whonet.code" }),
    },
    {
      key: "storageDefaults",
      header: intl.formatMessage({ id: "sample.type.storage.defaults" }),
    },
    {
      key: "isActive",
      header: intl.formatMessage({ id: "label.status.active" }),
    },
  ];
            ...
            <Column lg={16} md={8} sm={4}>
              ...
              >
                ...
                >
                  ...
                  >
                    Required columns: Name, Description, Display Order, WHONET
                    Code, Storage Defaults, Active
                  </p>
                </div>
              ...
              <Column lg={16} md={8} sm={4}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      Review the data above and click "Import Sample Types" to
                      proceed.
                    </p>
