...
const AddSampleTypeModal = ({ isOpen, onClose, onSubmit, isSubmitting }) => {
  const intl = useIntl();
  ...
  const validateForm = () => {
    ...
    if (!formData.displayOrder.trim()) {
      newErrors.displayOrder = intl.formatMessage({
        id: "sample.type.display.order.required",
      });
  ...
  return (
    <Modal
      ...
      modalHeading={<FormattedMessage id="sample.type.add.modal.title" />}
      ...
      <Form onSubmit={handleSubmit}>
        <FormGroup legendText="">
          <TextInput
            ...
            placeholder={intl.formatMessage({
              id: "sample.type.name.placeholder",
            })}
            value={formData.name}
        ...
        <FormGroup legendText="">
          <TextInput
            ...
            placeholder={intl.formatMessage({
              id: "sample.type.french.name.placeholder",
            })}
        ...
        <FormGroup legendText="">
          <TextInput
            id="sample-type-display-order"
            labelText={<FormattedMessage id="sample.type.display.order" />}
            placeholder={intl.formatMessage({
              id: "sample.type.display.order.placeholder",
            })}
        ...
        <FormGroup legendText="">
          <TextInput
            id="sample-type-storage-defaults"
            labelText={<FormattedMessage id="sample.type.storage.defaults" />}
            placeholder={intl.formatMessage({
              id: "sample.type.storage.defaults.placeholder",
            })}
            value={formData.storageDefaults}
            onChange={(e) =>
              handleInputChange("storageDefaults", e.target.value)
            }
            disabled={isSubmitting}
          />
        </FormGroup>
        ...
        {isSubmitting && (
          <InlineLoading
            ...
            description={<FormattedMessage id="sample.type.saving" />}
          />
        )}
      </Form>
    </Modal>
