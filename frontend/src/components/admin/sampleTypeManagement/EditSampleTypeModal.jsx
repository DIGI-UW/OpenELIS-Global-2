...
const EditSampleTypeModal = ({
  ...
  useEffect(() => {
    if (isOpen && sampleTypeData) {
      setFormData({
        ...
        displayOrder:
          sampleTypeData.sortOrder || sampleTypeData.testCount || "0",
        storageDefaults: sampleTypeData.storageDefaults || "",
        active:
          sampleTypeData.active !== undefined ? sampleTypeData.active : true,
      });
      setErrors({});
    }
  ...
  const validateForm = () => {
    ...
    if (!formData.description.trim()) {
      newErrors.description = intl.formatMessage({
        id: "sample.type.description.required",
        defaultMessage: "Description is required",
      });
    }

    if (!formData.frenchName.trim()) {
      newErrors.frenchName = intl.formatMessage({
        id: "sample.type.french.name.required",
        defaultMessage: "French name is required",
      });
    }
    ...
    if (
      ...
      !/^\d+$/.test(formData.displayOrder.trim())
    ) {
      newErrors.displayOrder = intl.formatMessage({
        id: "sample.type.display.order.invalid",
        defaultMessage: "Display order must be a number",
      });
    }

    // Add basic validation for other fields
    if (formData.abbreviation && formData.abbreviation.length > 10) {
      newErrors.abbreviation = intl.formatMessage({
        id: "sample.type.abbreviation.invalid",
        defaultMessage: "Abbreviation must be 10 characters or less",
      });
    }
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      onSubmit({
        ...
        displayOrder: formData.displayOrder.trim()
          ? parseInt(formData.displayOrder.trim())
          : 999,
  ...
  return (
    <Modal
      ...
      modalHeading={
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <span>
            {formData.name ||
              intl.formatMessage({
                id: "sample.type.edit.modal.title",
                defaultMessage: "Edit Sample Type",
              })}
          </span>
          {formData.domain && (
      ...
      modalLabel={
        <FormattedMessage
          id="sample.type.management"
          defaultMessage="Sample Type Management"
        />
      }
      primaryButtonText={intl.formatMessage({
        id: "button.update",
        defaultMessage: "Update Sample Type",
      })}
        ...
        <Form onSubmit={handleSubmit}>
          ...
          >
            <TabList>
              <Tab>
                <FormattedMessage
                  id="tab.sampleType.basicInfo"
                  defaultMessage="Basic Info"
                />
              </Tab>
              <Tab>
                <FormattedMessage
                  id="tab.sampleType.tests"
                  defaultMessage="Associated Tests"
                />
              </Tab>
            </TabList>
            <TabPanels>
                  ...
                  <Stack gap={7}>
                          ...
                          <Stack gap={5}>
                            ...
                            <TextArea
                              ...
                              helperText={intl.formatMessage({
                                ...
                                defaultMessage:
                                  "Provide a detailed description of this sample type for lab staff reference",
                              })}
                              disabled={isSubmitting}
                            />
                          </Stack>
                          ...
                          <Stack gap={5}>
                            <Select
                              ...
                              helperText={intl.formatMessage({
                                ...
                                defaultMessage:
                                  "Determines which workflow mode this sample type appears in",
                              })}
                              disabled={isSubmitting}
                              size="md"
                            >
                            ...
                            <div
                              style={{ paddingTop: "var(--cds-spacing-03)" }}
                            >
                              <Toggle
                    ...
                    >
                      <div style={{ marginBottom: "var(--cds-spacing-05)" }}>
                        ...
                        >
                          <FormattedMessage
                            id="section.sampleType.additional"
                        ...
                        <Column lg={8} md={4} sm={4}>
                          <TextInput
                            ...
                            helperText={intl.formatMessage({
                              ...
                              defaultMessage:
                                "Optional short code (max 10 characters)",
                            })}
                            maxLength={10}
                            disabled={isSubmitting}
                            size="md"
                        ...
                        <Column lg={8} md={4} sm={4}>
                          <TextInput
                            ...
                            labelText={
                              <>
                                <FormattedMessage
                                  id="sample.type.french.name"
                                  defaultMessage="French Name"
                                />
                                <span
                            ...
                            helperText={intl.formatMessage({
                              ...
                              defaultMessage:
                                "French translation of the sample type name",
                            })}
                            disabled={isSubmitting}
                            size="md"
          ...
          {isSubmitting && (
            ...
            >
              <InlineLoading
                ...
                description={
                  <FormattedMessage
                    id="sample.type.updating"
                    defaultMessage="Updating sample type..."
                  />
                }
              />
            </div>
