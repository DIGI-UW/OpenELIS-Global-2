...
function SampleTypeTestAssignment() {
  ...
  const handleSelectAllForSampleType = (sampleTypeId, isSelected) => {
    const sampleType = sampleTypesWithTests.find(
  ...
  const rows = [
    ...
    },
    {
      ...
      field: "Reassignment",
      description:
        "Select tests from any sample type and choose a new sample type to move them to.",
    },
  ];
      ...
      <div className="adminPageContent">
        ...
        <div className="orderLegendBody">
              ...
              <Grid fullWidth={true}>
                <Column lg={8} md={4} sm={2}>
                  <Select
                    ...
                    labelText={
                      <FormattedMessage id="configuration.sampleType.assign.new.type" />
                    }
          ...
          {sampleTypesWithTests.map((sampleType) => {
            const selectedForThisType = getSelectedTestsForSampleType(
              sampleType.id,
            );
            const allSelected =
                    ...
                    >
                      ...
                      {sampleType.tests.length > 0 && (
                        <Checkbox
                          ...
                          onChange={(checked) =>
                            handleSelectAllForSampleType(sampleType.id, checked)
                          }
                        />
                      )}
                    </div>
