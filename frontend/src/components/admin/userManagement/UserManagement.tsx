...
function UserManagement() {
  ...
  const [userManagementList, setUserManagementList] =
    useState<UserManagementResponse>();
                              ...
                              <TableRow
                                ...
                                onClick={() => {
                                  ...
                                  const CombinedUserID = (
                                    row as unknown as UserTableRow
                                  ).combinedUserID;
                                  const isSelected =
