...
interface ResultReportingResponse {
  cancelMethod?: string;
  cancelAction?: string;
  formMethod?: string;
  formName?: string;
...
function ResultReportingConfiguration() {
  ...
  const [reportsResp, setReportsResp] = useState<ResultReportingResponse>(
    {} as ResultReportingResponse,
  );
  const [reportsRespPost, setReportsRespPost] = useState<
    Partial<ResultReportingResponse>
  >({});
  const [saveButton, setSaveButton] = useState(true);
  const [reportsShow, setReportsShow] = useState<ReportConfiguration[]>([]);
  const [reportsShowMinList, setReportsShowMinList] = useState<string[]>([]);
  const [reportsShowHourList, setReportsShowHourList] = useState<string[]>([]);
