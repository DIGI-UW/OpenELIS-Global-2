...
interface SampleTypeTestAssignmentData {
  sampleTypeTestList?: Record<string, AssignmentTest[]>;
  sampleTypeList?: Array<{ id: string; value: string }>;
}

interface SampleTypeTestAssignmentPayload {
  testId?: string;
  testValue?: string;
  sampleTypeIdNew?: string;
  sampleTypeNameNew?: string;
  sampleTypeIdOld?: string;
  sampleTypeNameOld?: string;
}
...
function SampleTypeTestAssign() {
  ...
  const [sampleTypeTestAssignModal, setSampleTypeTestAssignModal] =
    useState(false);
  const [sampleTypeTestAssign, setSampleTypeTestAssign] =
    useState<SampleTypeTestAssignmentData>({});
  const [sampleTypeTestAssignPost, setSampleTypeTestAssignPost] =
    useState<SampleTypeTestAssignmentPayload>({
      testId: "",
      testValue: "",
      sampleTypeIdNew: "",
      sampleTypeNameNew: "",
