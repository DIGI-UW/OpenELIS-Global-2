...
import type { TestFormValues } from "./TestFormData";
...
interface TestStepFormProps {
  ...
  mode?: "add" | "edit";
  postCall: (data: TestFormValues) => void;
  cancelCall?: () => void;
}
...
export const TestStepForm = ({
  ...
  useEffect(() => {
    if (mode === "edit") {
      ...
      setFormData((prev) => ({
        ...
        resultLimits: normalizedLimits as TestFormValues["resultLimits"],
      }));
    }
  }, [
    initialData,
  ...
  const steps = [
    ...
    <StepTwoTestPanelAndUom
      key="step-2"
      formData={formData}
      // @ts-expect-error -- preserve the original unused child prop
      setFormData={setFormData}
      handleNextStep={handleNextStep}
                        ...
                        <React.Fragment key={index}>
                          ...
                          >
                            <TextInput
                              ...
                              onBlur={handleBlur}
                              // @ts-expect-error -- preserve the original legacy Carbon prop
                              label="Age Range (Low)"
                              size={"md"}
                              // min={0}
                              // max={1000}
