...
const TestCatalog = () => {
  ...
  const DataTableComponent = ({ item }) => {
    const headers = [
      { key: "field", header: intl.formatMessage({ id: "testCatalog.header.field" }) },
      { key: "value", header: intl.formatMessage({ id: "testCatalog.header.value" }) },
    ];
    ...
    const limitHeaders = [
      { key: "gender", header: intl.formatMessage({ id: "testCatalog.header.gender" }) },
      { key: "ageRange", header: intl.formatMessage({ id: "testCatalog.header.ageRange" }) },
      { key: "normalRange", header: intl.formatMessage({ id: "testCatalog.header.normalRange" }) },
      { key: "validRange", header: intl.formatMessage({ id: "testCatalog.header.validRange" }) },
      { key: "reportingRange", header: intl.formatMessage({ id: "testCatalog.header.reportingRange" }) },
      { key: "criticalRange", header: intl.formatMessage({ id: "testCatalog.header.criticalRange" }) },
    ];
