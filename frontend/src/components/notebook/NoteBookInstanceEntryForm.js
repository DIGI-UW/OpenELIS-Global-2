...
import AnalyticsWorkflowTab from "./workflow/AnalyticsWorkflowTab";
      ...
      <Grid fullWidth={true} className="orderLegendBody">
        ...
        {selectedTab === TABS.WORKFLOW && (
          <Column lg={16} md={8} sm={4}>
            ...
            {noteBookData?.isTemplate !== true &&
              noteBookData?.id &&
              noteBookData?.title?.toLowerCase().includes("analytics") && (
                <AnalyticsWorkflowTab notebookId={noteBookData.id} />
              )}
            {noteBookData?.isTemplate !== true &&
              noteBookData?.id &&
