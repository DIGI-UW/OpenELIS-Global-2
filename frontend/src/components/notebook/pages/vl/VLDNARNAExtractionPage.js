...
/**
 * VLDNARNAExtractionPage - Page 2: DNA/RNA Extraction
 *
 ...
 * }
 */
export const VLDNARNAExtractionPage = ({
  entryId,
  pageData = {},
  onProgressUpdate,
}) => {
    ...
    if (selectedSampleIds.length === 0) {
      notify({
        ...
        title: intl.formatMessage({
          id: "notebook.vl.extraction.error.noSample",
  ...
  const applyExtraction = useCallback(() => {
    ...
    if (!methodKit) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.extraction.error.requiredFields",
          defaultMessage: "Required Field Missing",
        }),
        message: intl.formatMessage({
          id: "notebook.vl.extraction.error.methodKitRequired",
    ...
    if (!lotNumbers || lotNumbers.trim() === "") {
      notify({
        ...
        message: intl.formatMessage({
          id: "notebook.vl.extraction.error.lotNumbersRequired",
    ...
    if (!operator || operator.trim() === "") {
      notify({
        ...
        message: intl.formatMessage({
          id: "notebook.vl.extraction.error.operatorRequired",
    ...
    if (!hasRealPageId) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.extraction.error.noPage",
          defaultMessage:
            ...
            (statusCode) => {
              if (statusCode === 200) {
                notify({
                  ...
                  title: intl.formatMessage(
                    {
                      id: "notebook.vl.extraction.success",
                ...
                notify({
                  kind: NotificationKinds.error,
                  title: intl.formatMessage({
                    id: "notebook.vl.extraction.error.statusUpdate",
                    defaultMessage:
  ...
  const handleMarkComplete = useCallback(() => {
    ...
    if (samplesToComplete.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.extraction.noEligibleSamples",
          defaultMessage:
      ...
      (response) => {
        ...
        if (response && response.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.vl.extraction.completeSuccess",
                defaultMessage:
          ...
          notify({
            ...
            title:
              response?.error ||
              intl.formatMessage({
                id: "notebook.vl.extraction.completeFailed",
  ...
  return (
    <div className="vl-dna-rna-extraction-page">
      <div className="page-section-header">
        <h4>
          <FormattedMessage
            id="notebook.vl.extraction.title"
            defaultMessage="DNA/RNA Extraction"
          />
        </h4>
        <p className="page-description">
          <FormattedMessage
            id="notebook.vl.extraction.description"
          ...
          <div className="progress-tiles">
            <Tile className="progress-tile">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.vl.extraction.ready"
            ...
            <Tile className="progress-tile verified">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.vl.extraction.extracted"
      ...
      <div className="page-actions-bar">
        ...
        >
          <FormattedMessage
            id="notebook.vl.recordExtraction"
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          <h5>
            <FormattedMessage
              id="notebook.vl.extraction.ready.title"
        ...
        <div className="sample-grid-container">
          {!loading && readyForExtractionSamples.length === 0 ? (
            <div className="empty-table-state">
              <p>
                <FormattedMessage
                  id="notebook.vl.extraction.ready.empty"
      ...
      {extractionCompletedSamples.length > 0 && (
        <div className="sample-table-section">
          <div className="table-section-header">
            <h5>
              <FormattedMessage
                id="notebook.vl.extraction.completed.title"
          ...
          <div className="sample-grid-container">
            <SampleGrid
              gridId="vl-extraction-completed"
      ...
      <Modal
        ...
        modalHeading={intl.formatMessage({
          id: "notebook.vl.extraction.modal.title",
        ...
        <Grid narrow>
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <Dropdown
              ...
              titleText={intl.formatMessage({
                id: "notebook.vl.extraction.methodKit",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.vl.extraction.lotNumbers",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="operator"
              labelText={intl.formatMessage({
                id: "notebook.vl.extraction.operator",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              id="dateTime"
              labelText={intl.formatMessage({
                id: "notebook.vl.extraction.dateTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextArea
              id="notes"
              labelText={intl.formatMessage({
                id: "notebook.vl.extraction.notes",
...
export default VLDNARNAExtractionPage;
