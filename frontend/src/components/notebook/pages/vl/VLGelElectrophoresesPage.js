...
/**
 * VLGelElectrophoresesPage - Page 5: Gel Electrophoresis
 *
 ...
 * }
 */
export const VLGelElectrophoresesPage = ({
  entryId,
  pageData = {},
  onProgressUpdate,
}) => {
    ...
    if (selectedSampleIds.length === 0) {
      notify({
        ...
        title: intl.formatMessage({
          id: "notebook.vl.gel.error.noSample",
    ...
    (files) => {
      ...
      if (!isValidType) {
        notify({
          kind: NotificationKinds.error,
          title: intl.formatMessage({
            id: "notebook.vl.gel.error.invalidFileType",
            defaultMessage: "Invalid File Type",
          }),
          message: intl.formatMessage({
            id: "notebook.vl.gel.error.imageRequired",
            defaultMessage:
      ...
      if (file.size > maxSizeBytes) {
        notify({
          kind: NotificationKinds.error,
          title: intl.formatMessage({
            id: "notebook.vl.gel.error.fileTooLarge",
            defaultMessage: "File Too Large",
          }),
          message: intl.formatMessage({
            id: "notebook.vl.gel.error.fileSizeLimit",
        ...
        (response) => {
          ...
          if (response?.success || response?.filePath) {
            ...
            notify({
              ...
              title: intl.formatMessage({
                id: "notebook.vl.gel.imageUploaded",
                defaultMessage: "Image Uploaded Successfully",
              }),
              message: intl.formatMessage(
                {
                  id: "notebook.vl.gel.imageUploadedMessage",
                  defaultMessage:
            ...
            notify({
              kind: NotificationKinds.error,
              title: intl.formatMessage({
                id: "notebook.vl.gel.error.imageUploadFailed",
                defaultMessage: "Image Upload Failed",
              }),
              message: intl.formatMessage({
                id: "notebook.vl.gel.error.tryAgain",
  ...
  const applyGel = useCallback(() => {
    if (!gelType) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.gel.error.requiredFields",
          defaultMessage: "Required Field Missing",
        }),
        message: intl.formatMessage({
          id: "notebook.vl.gel.error.typeRequired",
    ...
    if (!integrityStatus) {
      notify({
        ...
        message: intl.formatMessage({
          id: "notebook.vl.gel.error.integrityRequired",
    ...
    if (!hasRealPageId) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.gel.error.noPage",
          defaultMessage:
            ...
            (statusCode) => {
              if (statusCode === 200) {
                ...
                notify({
                  kind: NotificationKinds.error,
                  title: intl.formatMessage({
                    id: "notebook.vl.gel.error.statusUpdate",
                    defaultMessage:
  ...
  const handleMarkComplete = useCallback(() => {
    ...
    if (samplesToComplete.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.gel.noEligibleSamples",
          defaultMessage:
      ...
      (response) => {
        ...
        if (response && response.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.vl.gel.completeSuccess",
                defaultMessage:
          ...
          notify({
            ...
            title:
              response?.error ||
              intl.formatMessage({
                id: "notebook.vl.gel.completeFailed",
  ...
  const renderIntegrityStatus = (sample) => {
    ...
    if (!status) {
      return (
        <Tag type="gray" size="sm">
          <FormattedMessage
            id="notebook.vl.gel.notRecorded"
    ...
    if (status === "pass") {
      return (
        <Tag type="green" size="sm" renderIcon={CheckmarkFilled}>
          <FormattedMessage id="notebook.vl.gel.pass" defaultMessage="PASS" />
        </Tag>
      );
    }
    ...
    return (
      <Tag type="red" size="sm">
        <FormattedMessage id="notebook.vl.gel.fail" defaultMessage="FAIL" />
      </Tag>
    );
  };
  ...
  const renderReviewStatus = (sample) => {
    ...
    if (finalCompleted) {
      return (
        <Tag type="green" size="sm" renderIcon={CheckmarkFilled}>
          <FormattedMessage
            id="notebook.vl.gel.fullyApproved"
    ...
    if (bioCompleted) {
      return (
        <Tag type="blue" size="sm">
          <FormattedMessage
            id="notebook.vl.gel.bioApproved"
    ...
    if (primaryCompleted) {
      return (
        <Tag type="blue" size="sm">
          <FormattedMessage
            id="notebook.vl.gel.primaryApproved"
    ...
    return (
      <Tag type="gray" size="sm">
        <FormattedMessage
          id="notebook.vl.gel.reviewPending"
  ...
  return (
    <div className="vl-gel-electrophoresis-page">
      <div className="page-section-header">
        <h4>
          <FormattedMessage
            id="notebook.vl.gel.title"
            defaultMessage="Gel Electrophoresis"
          />
        </h4>
        <p className="page-description">
          <FormattedMessage
            id="notebook.vl.gel.description"
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          <h5>
            <FormattedMessage
              id="notebook.vl.gel.ready.title"
        ...
        <div className="sample-grid-container">
          {!loading && readyForGelSamples.length === 0 ? (
            <div className="empty-table-state">
              <p>
                <FormattedMessage
                  id="notebook.vl.gel.ready.empty"
      ...
      {gelCompletedSamples.length > 0 && (
        <div className="sample-table-section">
          <div className="table-section-header">
            <h5>
              <FormattedMessage
                id="notebook.vl.gel.completed.title"
      ...
      <Modal
        ...
        modalHeading={intl.formatMessage({
          id: "notebook.vl.gel.modal.title",
        ...
        <Grid narrow>
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              ...
              label={intl.formatMessage({
                id: "notebook.vl.gel.productSize",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              id="concentration"
              label={intl.formatMessage({
                id: "notebook.vl.gel.concentration",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <Dropdown
              id="integrity-status"
              titleText={intl.formatMessage({
                id: "notebook.vl.gel.integrityStatus",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              id="recorded-date"
              labelText={intl.formatMessage({
                id: "notebook.vl.gel.recordedDate",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="recorded-time"
              labelText={intl.formatMessage({
                id: "notebook.vl.gel.recordedTime",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="last-modified-by"
              labelText={intl.formatMessage({
                id: "notebook.vl.gel.lastModifiedBy",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.vl.gel.lastModifiedDate",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.vl.gel.lastModifiedTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6 style={{ marginBottom: "1rem", marginTop: "1rem" }}>
              <FormattedMessage
                id="notebook.vl.gel.reviewWorkflow"
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.vl.gel.primaryReview"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="primary-reviewer"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.gel.primaryReviewer",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.gel.primaryReviewDate",
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.gel.primaryReviewTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.vl.gel.bioinformaticsReview"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="bio-reviewer"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.gel.bioReviewer",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  id="bio-review-date"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.gel.bioReviewDate",
                    defaultMessage: "Review Date",
                  })}
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="bio-review-time"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.gel.bioReviewTime",
                    defaultMessage: "Review Time",
                  })}
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.vl.gel.finalApproval"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="final-approver"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.gel.finalApprover",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.gel.finalApprovalDate",
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.gel.finalApprovalTime",
...
export default VLGelElectrophoresesPage;
