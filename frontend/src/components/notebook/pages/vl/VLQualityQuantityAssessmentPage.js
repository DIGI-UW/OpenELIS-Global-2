...
/**
 * VLQualityQuantityAssessmentPage - Page 3: Quality & Quantity Assessment
 *
 ...
 * }
 */
export const VLQualityQuantityAssessmentPage = ({
  entryId,
  pageData = {},
  onProgressUpdate,
}) => {
  ...
  // Quality & Quantity Assessment allowed roles - per VL permission mapping
  const allowedRoles = [
    "VL Lab Technician",
    "VL Manager",
  ...
  // QC Thresholds per VL Implementation Guide - STAGE 3: Quality & Quantity Assessment
    ...
    if (selectedSampleIds.length === 0) {
      notify({
        ...
        title: intl.formatMessage({
          id: "notebook.vl.qc.error.noSample",
  ...
  const applyQC = useCallback(() => {
    ...
    if (
      ...
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.qc.error.requiredFields",
          defaultMessage: "Required Field Missing",
        }),
        message: intl.formatMessage({
          id: "notebook.vl.qc.error.atLeastOneQC",
          defaultMessage:
    ...
    if (!hasRealPageId) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.qc.error.noPage",
          defaultMessage:
            ...
            (statusCode) => {
              if (statusCode === 200) {
                ...
                notify({
                  kind: NotificationKinds.error,
                  title: intl.formatMessage({
                    id: "notebook.vl.qc.error.statusUpdate",
                    defaultMessage:
  ...
  const handleMarkComplete = useCallback(() => {
    ...
    if (samplesToComplete.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.qc.noEligibleSamples",
          defaultMessage:
      ...
      (response) => {
        ...
        if (response && response.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.vl.qc.completeSuccess",
                defaultMessage:
          ...
          notify({
            ...
            title:
              response?.error ||
              intl.formatMessage({
                id: "notebook.vl.qc.completeFailed",
  ...
  const renderQCStatus = (sample) => {
    ...
    if (!qcStatus) {
      return (
        <Tag type="gray" size="sm">
          <FormattedMessage
            id="notebook.vl.qc.status.notRecorded"
  ...
  return (
    <div className="vl-qc-assessment-page">
      <div className="page-section-header">
        <h4>
          <FormattedMessage
            id="notebook.vl.qc.title"
            defaultMessage="Quality & Quantity Assessment"
          />
        </h4>
        <p className="page-description">
          <FormattedMessage
            id="notebook.vl.qc.description"
      ...
      <InlineNotification
        kind="info"
        title={intl.formatMessage({
          id: "notebook.vl.qc.criteria.title",
          defaultMessage: "QC Pass/Fail Criteria",
        })}
        subtitle={intl.formatMessage({
          id: "notebook.vl.qc.criteria.explanation",
          defaultMessage:
              ...
              columns={[
                ...
                },
                {
                  ...
                  header: intl.formatMessage({
                    id: "notebook.vl.qc.column.qcStatus",
      ...
      {qcCompletedSamples.length > 0 && (
        <div className="sample-table-section">
          <div className="table-section-header">
            <h5>
              <FormattedMessage
                id="notebook.vl.qc.completed.title"
      ...
      >
        ...
        <Grid narrow>
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1.5rem" }}>
            ...
            >
              <p style={{ margin: 0, fontSize: "0.875rem", color: "#333" }}>
                <strong>
                  <FormattedMessage
                    id="notebook.vl.qc.instructions"
                    defaultMessage="STAGE 3: Quality & Quantity Assessment"
                  />
                </strong>
                <br />
                <FormattedMessage
                  id="notebook.vl.qc.description.detailed"
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6>
              <FormattedMessage
                id="notebook.vl.qc.section.nanodrop"
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              ...
              label={intl.formatMessage({
                id: "notebook.vl.qc.nanodrop.concentration",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6>
              <FormattedMessage
                id="notebook.vl.qc.section.qubit"
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              ...
              label={intl.formatMessage({
                id: "notebook.vl.qc.qubit.concentration",
                defaultMessage: "Concentration (ng/µL)",
              })}
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6>
              <FormattedMessage
                id="notebook.vl.qc.section.bioanalyzer"
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              id="rin"
              label={intl.formatMessage({
                id: "notebook.vl.qc.bioanalyzer.rin",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              id="fragment-size"
              label={intl.formatMessage({
                id: "notebook.vl.qc.bioanalyzer.fragmentSize",
...
export default VLQualityQuantityAssessmentPage;
