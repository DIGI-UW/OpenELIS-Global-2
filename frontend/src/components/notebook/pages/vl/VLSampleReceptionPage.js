...
import VLManifestImportModal from "../../workflow/VLManifestImportModal";
import AccessDeniedMessage from "../../../common/AccessDeniedMessage";
import SampleGrid from "../../workflow/SampleGrid";

/**
 * VLSampleReceptionPage - STAGE 1: Sample Reception & Registration
 *
 ...
 */
export const VLSampleReceptionPage = ({
  samples = [],
  pageData = {},
  entryId,
  onSampleUpdate,
    ...
    async (importResult) => {
      try {
        if (importResult && importResult.success) {
          ...
          addNotification({
            ...
            title: intl.formatMessage({
              id: "notebook.vl.manifest.imported",
              defaultMessage: "Manifest Imported",
            }),
            message: intl.formatMessage(
              {
                id: "notebook.vl.manifest.importedMessage",
                defaultMessage:
        ...
        addNotification({
          ...
          title: intl.formatMessage({
            id: "notebook.vl.manifest.importError",
  ...
  const handleMarkComplete = useCallback(async () => {
    if (selectedSampleIds.length === 0) {
      ...
      addNotification({
        ...
        title: intl.formatMessage({
          id: "notebook.vl.noSamplesSelected.title",
    ...
    try {
      ...
      addNotification({
        kind: NotificationKinds.success,
        title: intl.formatMessage({
          id: "notebook.vl.reception.samplesCompleted",
          defaultMessage: "Samples Completed",
        }),
        message: intl.formatMessage(
          {
            id: "notebook.vl.reception.samplesCompletedMessage",
            defaultMessage:
      ...
      addNotification({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.reception.error",
  ...
  return (
    <div className="vl-sample-reception-page">
      {/* Page Section Header */}
      <div className="page-section-header">
        <h4>
          <FormattedMessage
            id="notebook.vl.reception.title"
            defaultMessage="Sample Reception & Registration"
          />
        </h4>
        <p className="page-description">
          <FormattedMessage
            id="notebook.vl.reception.description"
          ...
          <div className="progress-tiles">
            <Tile className="progress-tile">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.vl.reception.awaitingReception"
            ...
            <Tile className="progress-tile">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.vl.reception.samplesReceived"
      ...
      <div className="page-actions-bar">
        ...
        >
          <FormattedMessage
            id="notebook.vl.reception.importManifest"
        ...
        >
          <FormattedMessage
            id="notebook.vl.reception.markComplete"
        ...
        >
          <FormattedMessage
            id="notebook.vl.reception.refresh"
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          ...
          <p className="table-section-description">
            <FormattedMessage
              id="notebook.vl.reception.awaitingDescription"
        ...
        {pendingSamples.length === 0 ? (
          <div className="empty-table-state">
            <FormattedMessage
              id="notebook.vl.reception.noSamplesAwaiting"
              ...
              columns={[
                {
                  ...
                  header: intl.formatMessage({
                    id: "notebook.vl.reception.sampleId",
                ...
                },
                {
                  key: "sampleType",
                  header: intl.formatMessage({
                    id: "notebook.vl.reception.sampleType",
                ...
                },
                {
                  key: "source",
                  header: intl.formatMessage({
                    id: "notebook.vl.reception.source",
                ...
                },
                {
                  key: "collectionDate",
                  header: intl.formatMessage({
                    id: "notebook.vl.reception.collectionDate",
                ...
                },
                {
                  ...
                  header: intl.formatMessage({
                    id: "notebook.vl.reception.volumeConcentration",
                ...
                },
                {
                  key: "operator",
                  header: intl.formatMessage({
                    id: "notebook.vl.reception.operator",
                ...
                },
                {
                  key: "status",
                  header: intl.formatMessage({
                    id: "notebook.vl.reception.status",
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          ...
          <p className="table-section-description">
            <FormattedMessage
              id="notebook.vl.reception.receivedDescription"
        ...
        {receivedSamples.length === 0 ? (
          <div className="empty-table-state">
            <FormattedMessage
              id="notebook.vl.reception.noSamplesReceived"
              defaultMessage="No received samples yet"
            />
          </div>
        ) : (
          <SampleGrid
            gridId="vl-reception-received"
