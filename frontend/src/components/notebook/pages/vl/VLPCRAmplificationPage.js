...
/**
 * VLPCRAmplificationPage - Page 4: PCR Amplification
 *
 ...
 * }
 */
export const VLPCRAmplificationPage = ({
  entryId,
  pageData = {},
  onProgressUpdate,
}) => {
    ...
    if (selectedSampleIds.length === 0) {
      notify({
        ...
        title: intl.formatMessage({
          id: "notebook.vl.pcr.error.noSample",
  ...
  const applyPCR = useCallback(() => {
    if (!pcrType) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.pcr.error.requiredFields",
          defaultMessage: "Required Field Missing",
        }),
        message: intl.formatMessage({
          id: "notebook.vl.pcr.error.typeRequired",
    ...
    if (!hasRealPageId) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.pcr.error.noPage",
          defaultMessage:
            ...
            (statusCode) => {
              if (statusCode === 200) {
                ...
                notify({
                  kind: NotificationKinds.error,
                  title: intl.formatMessage({
                    id: "notebook.vl.pcr.error.statusUpdate",
                    defaultMessage:
  ...
  const handleMarkComplete = useCallback(() => {
    ...
    if (samplesToComplete.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.pcr.noEligibleSamples",
          defaultMessage:
      ...
      (response) => {
        ...
        if (response && response.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.vl.pcr.completeSuccess",
                defaultMessage:
          ...
          notify({
            ...
            title:
              response?.error ||
              intl.formatMessage({
                id: "notebook.vl.pcr.completeFailed",
  ...
  return (
    <div className="vl-pcr-amplification-page">
      <div className="page-section-header">
        <h4>
          <FormattedMessage
            id="notebook.vl.pcr.title"
            defaultMessage="PCR Amplification"
          />
        </h4>
        <p className="page-description">
          <FormattedMessage
            id="notebook.vl.pcr.description"
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          <h5>
            <FormattedMessage
              id="notebook.vl.pcr.ready.title"
        ...
        <div className="sample-grid-container">
          {!loading && readyForPCRSamples.length === 0 ? (
            <div className="empty-table-state">
              <p>
                <FormattedMessage
                  id="notebook.vl.pcr.ready.empty"
      ...
      {pcrCompletedSamples.length > 0 && (
        <div className="sample-table-section">
          <div className="table-section-header">
            <h5>
              <FormattedMessage
                id="notebook.vl.pcr.completed.title"
      ...
      <Modal
        ...
        modalHeading={intl.formatMessage({
          id: "notebook.vl.pcr.modal.title",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              ...
              label={intl.formatMessage({
                id: "notebook.vl.pcr.expectedBandSize",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextArea
              ...
              labelText={intl.formatMessage({
                id: "notebook.vl.pcr.cyclingConditions",
            ...
            >
              ...
              <div style={{ marginBottom: "1rem" }}>
                <Checkbox
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.pcr.positiveControlPresent",
                ...
                <>
                  <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                    <NumberInput
                      ...
                      label={intl.formatMessage({
                        id: "notebook.vl.pcr.positiveControlBandSize",
                  ...
                  >
                    <TextArea
                      ...
                      labelText={intl.formatMessage({
                        id: "notebook.vl.pcr.positiveControlNotes",
              ...
              <div style={{ marginBottom: "1rem" }}>
                <Checkbox
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.pcr.negativeControlPresent",
                ...
                <>
                  <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                    <Dropdown
                      ...
                      titleText={intl.formatMessage({
                        id: "notebook.vl.pcr.negativeControlResult",
                  ...
                  >
                    <TextArea
                      ...
                      labelText={intl.formatMessage({
                        id: "notebook.vl.pcr.negativeControlNotes",
...
export default VLPCRAmplificationPage;
