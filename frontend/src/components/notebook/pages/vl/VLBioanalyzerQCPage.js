...
/**
 * VLBioanalyzerQCPage - Page 7: Bioanalyzer QC
 *
 ...
 * }
 */
export const VLBioanalyzerQCPage = ({
  entryId,
  pageData = {},
  onProgressUpdate,
}) => {
  ...
  // Bioanalyzer QC allowed roles - per VL permission mapping
  const allowedRoles = [
    "VL Lab Technician",
    "VL Manager",
    ...
    if (selectedSampleIds.length === 0) {
      notify({
        ...
        title: intl.formatMessage({
          id: "notebook.vl.bioanalyzer.error.noSample",
  ...
  const applyBioanalyzer = useCallback(() => {
    ...
    if (!chipType) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.bioanalyzer.error.requiredFields",
          defaultMessage: "Required Field Missing",
        }),
        message: intl.formatMessage({
          id: "notebook.vl.bioanalyzer.error.chipTypeRequired",
    ...
    if (!hasRealPageId) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.bioanalyzer.error.noPage",
          defaultMessage:
            ...
            (statusCode) => {
              if (statusCode === 200) {
                notify({
                  ...
                  title: intl.formatMessage(
                    {
                      id: "notebook.vl.bioanalyzer.success",
                      defaultMessage:
                ...
                notify({
                  kind: NotificationKinds.error,
                  title: intl.formatMessage({
                    id: "notebook.vl.bioanalyzer.error.statusUpdate",
                    defaultMessage:
  ...
  const handleMarkComplete = useCallback(() => {
    ...
    if (samplesToComplete.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.bioanalyzer.noEligibleSamples",
          defaultMessage:
      ...
      (response) => {
        ...
        if (response && response.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.vl.bioanalyzer.completeSuccess",
                defaultMessage:
          ...
          notify({
            ...
            title:
              response?.error ||
              intl.formatMessage({
                id: "notebook.vl.bioanalyzer.completeFailed",
  ...
  const renderReviewStatus = (sample) => {
    ...
    if (finalCompleted) {
      return (
        <Tag type="green" size="sm" renderIcon={CheckmarkFilled}>
          <FormattedMessage
            id="notebook.vl.bioanalyzer.fullyApproved"
    ...
    if (bioCompleted) {
      return (
        <Tag type="blue" size="sm">
          <FormattedMessage
            id="notebook.vl.bioanalyzer.bioApproved"
    ...
    if (primaryCompleted) {
      return (
        <Tag type="blue" size="sm">
          <FormattedMessage
            id="notebook.vl.bioanalyzer.primaryApproved"
    ...
    return (
      <Tag type="gray" size="sm">
        <FormattedMessage
          id="notebook.vl.bioanalyzer.reviewPending"
  ...
  return (
    <div className="vl-bioanalyzer-qc-page">
      <div className="page-section-header">
        <h4>
          <FormattedMessage
            id="notebook.vl.bioanalyzer.title"
            defaultMessage="Bioanalyzer QC"
          />
        </h4>
        <p className="page-description">
          <FormattedMessage
            id="notebook.vl.bioanalyzer.description"
          ...
          <div className="progress-tiles">
            <Tile className="progress-tile">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.vl.bioanalyzer.ready"
            ...
            <Tile className="progress-tile verified">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.vl.bioanalyzer.completed"
      ...
      <div className="page-actions-bar">
        ...
        >
          <FormattedMessage
            id="notebook.vl.recordBioanalyzer"
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          <h5>
            <FormattedMessage
              id="notebook.vl.bioanalyzer.ready.title"
        ...
        <div className="sample-grid-container">
          {!loading && readyForBioanalyzerSamples.length === 0 ? (
            <div className="empty-table-state">
              <p>
                <FormattedMessage
                  id="notebook.vl.bioanalyzer.ready.empty"
      ...
      {bioanalyzerCompletedSamples.length > 0 && (
        <div className="sample-table-section">
          <div className="table-section-header">
            <h5>
              <FormattedMessage
                id="notebook.vl.bioanalyzer.completed.title"
                defaultMessage="Bioanalyzer QC Completed"
              />
          ...
          <div className="sample-grid-container">
            <SampleGrid
              gridId="vl-bioanalyzer-completed"
      ...
      <Modal
        ...
        modalHeading={intl.formatMessage({
          id: "notebook.vl.bioanalyzer.modal.title",
        ...
        <Grid narrow>
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <Dropdown
              ...
              titleText={intl.formatMessage({
                id: "notebook.vl.bioanalyzer.chipType",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              ...
              label={intl.formatMessage({
                id: "notebook.vl.bioanalyzer.concentration",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.vl.bioanalyzer.sizeDistribution",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="adapter-dimers"
              labelText={intl.formatMessage({
                id: "notebook.vl.bioanalyzer.adapterDimers",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="operator"
              labelText={intl.formatMessage({
                id: "notebook.vl.bioanalyzer.operator",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.vl.bioanalyzer.dateTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            ...
            >
              ...
              >
                <FormattedMessage
                  id="notebook.vl.bioanalyzer.acceptanceCriteria"
              ...
              <div style={{ marginBottom: "1rem" }}>
                <Checkbox
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.bioanalyzer.criteriaMetLabel",
                    defaultMessage:
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: 0 }}>
                <TextArea
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.bioanalyzer.acceptanceCriteriaDetails",
                    defaultMessage:
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextArea
              ...
              labelText={intl.formatMessage({
                id: "notebook.vl.bioanalyzer.notes",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6 style={{ marginBottom: "1rem", marginTop: "1rem" }}>
              <FormattedMessage
                id="notebook.vl.bioanalyzer.auditTrail"
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="recorded-by"
              labelText={intl.formatMessage({
                id: "notebook.vl.bioanalyzer.recordedBy",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              id="recorded-date"
              labelText={intl.formatMessage({
                id: "notebook.vl.bioanalyzer.recordedDate",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="recorded-time"
              labelText={intl.formatMessage({
                id: "notebook.vl.bioanalyzer.recordedTime",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="last-modified-by"
              labelText={intl.formatMessage({
                id: "notebook.vl.bioanalyzer.lastModifiedBy",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.vl.bioanalyzer.lastModifiedDate",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.vl.bioanalyzer.lastModifiedTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6 style={{ marginBottom: "1rem", marginTop: "1rem" }}>
              <FormattedMessage
                id="notebook.vl.bioanalyzer.reviewWorkflow"
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.vl.bioanalyzer.primaryReview"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="primary-reviewer"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.bioanalyzer.primaryReviewer",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.bioanalyzer.primaryReviewDate",
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.bioanalyzer.primaryReviewTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.vl.bioanalyzer.bioinformaticsReview"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="bio-reviewer"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.bioanalyzer.bioReviewer",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  id="bio-review-date"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.bioanalyzer.bioReviewDate",
                    defaultMessage: "Review Date",
                  })}
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="bio-review-time"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.bioanalyzer.bioReviewTime",
                    defaultMessage: "Review Time",
                  })}
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.vl.bioanalyzer.finalApproval"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="final-approver"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.bioanalyzer.finalApprover",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.bioanalyzer.finalApprovalDate",
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.bioanalyzer.finalApprovalTime",
...
export default VLBioanalyzerQCPage;
