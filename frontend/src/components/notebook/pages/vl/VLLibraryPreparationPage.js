...
/**
 * VLLibraryPreparationPage - Page 6: Library Preparation
 *
 ...
 * }
 */
export const VLLibraryPreparationPage = ({
  entryId,
  pageData = {},
  onProgressUpdate,
}) => {
    ...
    if (selectedSampleIds.length === 0) {
      notify({
        ...
        title: intl.formatMessage({
          id: "notebook.vl.library.error.noSample",
  ...
  const applyLibrary = useCallback(() => {
    if (!platform) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.library.error.requiredFields",
          defaultMessage: "Required Field Missing",
        }),
        message: intl.formatMessage({
          id: "notebook.vl.library.error.platformRequired",
    ...
    if (!hasRealPageId) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.library.error.noPage",
          defaultMessage:
            ...
            (statusCode) => {
              if (statusCode === 200) {
                notify({
                  ...
                  title: intl.formatMessage(
                    {
                      id: "notebook.vl.library.success",
                      defaultMessage:
                ...
                notify({
                  kind: NotificationKinds.error,
                  title: intl.formatMessage({
                    id: "notebook.vl.library.error.statusUpdate",
                    defaultMessage:
  ...
  const handleMarkComplete = useCallback(() => {
    ...
    if (samplesToComplete.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.vl.library.noEligibleSamples",
          defaultMessage:
      ...
      (response) => {
        ...
        if (response && response.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.vl.library.completeSuccess",
                defaultMessage:
          ...
          notify({
            ...
            title:
              response?.error ||
              intl.formatMessage({
                id: "notebook.vl.library.completeFailed",
  ...
  const renderReviewStatus = (sample) => {
    ...
    if (finalCompleted) {
      return (
        <Tag type="green" size="sm" renderIcon={CheckmarkFilled}>
          <FormattedMessage
            id="notebook.vl.library.fullyApproved"
    ...
    if (bioCompleted) {
      return (
        <Tag type="blue" size="sm">
          <FormattedMessage
            id="notebook.vl.library.bioApproved"
    ...
    if (primaryCompleted) {
      return (
        <Tag type="blue" size="sm">
          <FormattedMessage
            id="notebook.vl.library.primaryApproved"
    ...
    return (
      <Tag type="gray" size="sm">
        <FormattedMessage
          id="notebook.vl.library.reviewPending"
  ...
  return (
    <div className="vl-library-preparation-page">
      <div className="page-section-header">
        <h4>
          <FormattedMessage
            id="notebook.vl.library.title"
            defaultMessage="Library Preparation"
          />
        </h4>
        <p className="page-description">
          <FormattedMessage
            id="notebook.vl.library.description"
        ...
        <Column lg={16} md={8} sm={4}>
          <div className="progress-tiles">
            ...
            <Tile className="progress-tile verified">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.vl.library.completed"
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          <h5>
            <FormattedMessage
              id="notebook.vl.library.ready.title"
        ...
        <div className="sample-grid-container">
          {!loading && readyForLibrarySamples.length === 0 ? (
            <div className="empty-table-state">
              <p>
                <FormattedMessage
                  id="notebook.vl.library.ready.empty"
      ...
      {libraryCompletedSamples.length > 0 && (
        <div className="sample-table-section">
          <div className="table-section-header">
            <h5>
              <FormattedMessage
                id="notebook.vl.library.completed.title"
      ...
      <Modal
        ...
        modalHeading={intl.formatMessage({
          id: "notebook.vl.library.modal.title",
        ...
        <Grid narrow>
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <Dropdown
              ...
              titleText={intl.formatMessage({
                id: "notebook.vl.library.platform",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <Dropdown
              id="libraryProtocol"
              titleText={intl.formatMessage({
                id: "notebook.vl.library.protocol",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              ...
              label={intl.formatMessage({
                id: "notebook.vl.library.concentration",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.vl.library.sizeDistribution",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="barcode"
              labelText={intl.formatMessage({
                id: "notebook.vl.library.barcode",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="adapterIndex1"
              labelText={intl.formatMessage({
                id: "notebook.vl.library.adapterIndex1",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="adapterIndex2"
              labelText={intl.formatMessage({
                id: "notebook.vl.library.adapterIndex2",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="poolingGroup"
              labelText={intl.formatMessage({
                id: "notebook.vl.library.poolingGroup",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="operator"
              labelText={intl.formatMessage({
                id: "notebook.vl.library.operator",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              id="library-dateTime"
              labelText={intl.formatMessage({
                id: "notebook.vl.library.dateTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6 style={{ marginBottom: "1rem", marginTop: "1rem" }}>
              <FormattedMessage
                id="notebook.vl.library.auditTrail"
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="recorded-by"
              labelText={intl.formatMessage({
                id: "notebook.vl.library.recordedBy",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              id="recorded-date"
              labelText={intl.formatMessage({
                id: "notebook.vl.library.recordedDate",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="recorded-time"
              labelText={intl.formatMessage({
                id: "notebook.vl.library.recordedTime",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="last-modified-by"
              labelText={intl.formatMessage({
                id: "notebook.vl.library.lastModifiedBy",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.vl.library.lastModifiedDate",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.vl.library.lastModifiedTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6 style={{ marginBottom: "1rem", marginTop: "1rem" }}>
              <FormattedMessage
                id="notebook.vl.library.reviewWorkflow"
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.vl.library.primaryReview"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="primary-reviewer"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.library.primaryReviewer",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.library.primaryReviewDate",
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.library.primaryReviewTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.vl.library.bioinformaticsReview"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="bio-reviewer"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.library.bioReviewer",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  id="bio-review-date"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.library.bioReviewDate",
                    defaultMessage: "Review Date",
                  })}
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="bio-review-time"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.library.bioReviewTime",
                    defaultMessage: "Review Time",
                  })}
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.vl.library.finalApproval"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="final-approver"
                  labelText={intl.formatMessage({
                    id: "notebook.vl.library.finalApprover",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.library.finalApprovalDate",
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.vl.library.finalApprovalTime",
...
export default VLLibraryPreparationPage;
