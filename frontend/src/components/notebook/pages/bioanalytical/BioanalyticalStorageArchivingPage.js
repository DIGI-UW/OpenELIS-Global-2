    ...
    <div className="bioanalytical-page">
      ...
      >
        <TabList aria-label="Storage and archival tabs">
          ...
          <Tab>
            <FormattedMessage
              id="notebook.bioanalytical.storage.tab.biorepository"
              defaultMessage="Biorepository Transfer"
            />
          </Tab>
          <Tab>
            <FormattedMessage
              id="notebook.bioanalytical.storage.tab.retention"
              defaultMessage="Retention Storage (-80°C)"
            />
          </Tab>
          <Tab>
            <FormattedMessage
        ...
        <TabPanels>
              ...
              <Grid>
                <Column lg={16} md={8} sm={4}>
                  <div className="section-header">
                    <h4>
                      <FormattedMessage
                        id="notebook.bioanalytical.storage.biorepositorySection"
                        defaultMessage="Biorepository Laboratory Transfer"
                      />
                    </h4>
                    <p>
                      <FormattedMessage
                        id="notebook.bioanalytical.storage.biorepositoryHelp"
                        defaultMessage="Transfer selected samples to Biorepository Laboratory for long-term storage. Biorepository maintains samples under controlled conditions with full chain of custody documentation."
                      />
                    </p>
                    ...
                    >
                      <p style={{ fontSize: "0.875rem", margin: 0 }}>
                        <strong>
                          <FormattedMessage
                            id="notebook.bioanalytical.storage.transferInfo"
                            defaultMessage="Transfer Requirements:"
                          />
                        </strong>
                      </p>
                      <ul
                      ...
                      >
                        <li>
                          <FormattedMessage
                            id="notebook.bioanalytical.storage.transfer1"
                            defaultMessage="Complete chain of custody documentation"
                          />
                        </li>
                        <li>
                          <FormattedMessage
                            id="notebook.bioanalytical.storage.transfer2"
                            defaultMessage="Temperature monitoring during transport"
                          />
                        </li>
                        <li>
                          <FormattedMessage
                            id="notebook.bioanalytical.storage.transfer3"
                            defaultMessage="Biorepository receipt confirmation required"
                          />
                        </li>
                        <li>
                          <FormattedMessage
                            id="notebook.bioanalytical.storage.transfer4"
                            defaultMessage="Sample integrity verification upon arrival"
                          />
                        </li>
                      </ul>
                    </div>
                    ...
                    {selectedSamples.size > 0 && (
                      ...
                      >
                        <p style={{ fontSize: "0.875rem", margin: 0 }}>
                          <strong>
                            <FormattedMessage
                              id="notebook.bioanalytical.storage.selectedForTransfer"
                              defaultMessage="Selected for Transfer:"
                            />
                          </strong>{" "}
                        ...
                        >
                          <FormattedMessage
                            id="notebook.bioanalytical.storage.transferConditions"
                            defaultMessage="Samples will be transferred to biorepository using -80°C storage devices with 2-year retention requirement for bioequivalence studies. Storage location will be automatically assigned based on available capacity."
                          />
                        </p>
                      </div>
                    )}
                    ...
                    <div style={{ marginTop: "1.5rem" }}>
                      ...
                      >
                        <FormattedMessage
                          id="notebook.bioanalytical.storage.transferToBiorepository"
                          defaultMessage="Transfer Selected Samples to Biorepository"
                        />
                      </Button>
                    </div>

                    {biorepositoryTransfer.length > 0 && (
                      <div style={{ marginTop: "2rem" }}>
                        <h5>
                          <FormattedMessage
                            id="notebook.bioanalytical.storage.transferHistory"
                        ...
                        <Table style={{ marginTop: "1rem" }}>
                          <TableHead>
                            <TableRow>
                              ...
                              <TableHeader>
                                <FormattedMessage
                                  id="notebook.bioanalytical.storage.transferDate"
                                  defaultMessage="Transfer Date"
                                />
                              </TableHeader>
                              <TableHeader>
                                <FormattedMessage
                                  id="notebook.bioanalytical.storage.storageCondition"
                              ...
                              <TableHeader>
                                <FormattedMessage
                                  id="notebook.bioanalytical.storage.transferType"
                          ...
                          <TableBody>
                            {biorepositoryTransfer.map((transfer, index) => (
                              <TableRow key={index}>
                  ...
                  <div className="section-header">
                    <h4>
                      <FormattedMessage
                        ...
                        defaultMessage="Retention Storage (2 Years at -80°C)"
                      />
                    </h4>
                    <p>
                      <FormattedMessage
                        id="notebook.bioanalytical.storage.retentionHelp"
                        defaultMessage="Store retention quantity of analyzed samples for 2 years at -80°C as required for bioequivalence studies. This storage ensures sample integrity for potential regulatory inspections or reanalysis requests."
                      />
                    </p>
                    ...
                    >
                      <p style={{ fontSize: "0.875rem", margin: 0 }}>
                        <strong>
                          <FormattedMessage
                            id="notebook.bioanalytical.storage.retentionRequirements"
                            defaultMessage="FDA Bioequivalence Retention Requirements:"
                          />
                        </strong>
                      </p>
                      <ul
                      ...
                      >
                        <li>
                          <FormattedMessage
                            id="notebook.bioanalytical.storage.retention1"
                            defaultMessage="Storage temperature: -80°C (±5°C tolerance)"
                          />
                        </li>
                        <li>
                          <FormattedMessage
                            id="notebook.bioanalytical.storage.retention2"
                            defaultMessage="Retention duration: 2 years minimum"
                          />
                        </li>
                        <li>
                          <FormattedMessage
                            id="notebook.bioanalytical.storage.retention3"
                            defaultMessage="Legal hold: Yes (regulatory requirement)"
                          />
                        </li>
                        <li>
                          <FormattedMessage
                            id="notebook.bioanalytical.storage.retention4"
                            defaultMessage="Sample integrity verification required"
                          />
                        </li>
                      </ul>
                    </div>
                    ...
                    {selectedSamples.size > 0 && (
                      ...
                      >
                        <p style={{ fontSize: "0.875rem", margin: 0 }}>
                          <strong>
                            <FormattedMessage
                              id="notebook.bioanalytical.storage.selectedForRetention"
                              defaultMessage="Selected for Retention Storage:"
                            />
                          </strong>{" "}
                          {selectedSamples.size} samples
                        </p>
                    ...
                    <div style={{ marginTop: "1.5rem" }}>
                      ...
                      >
                        <FormattedMessage
                          id="notebook.bioanalytical.storage.setRetentionStorage"
                          defaultMessage="Set Retention Storage (-80°C)"
                        />
                      </Button>
                    </div>

                    {retentionStorage.length > 0 && (
                      <div style={{ marginTop: "2rem" }}>
                        <h5>
                          <FormattedMessage
                            id="notebook.bioanalytical.storage.retentionHistory"
                            defaultMessage="Retention Storage History"
                          />
                        </h5>
                        <Table style={{ marginTop: "1rem" }}>
                          <TableHead>
                            <TableRow>
                              ...
                              <TableHeader>
                                <FormattedMessage
                                  id="notebook.bioanalytical.storage.storageDate"
                              ...
                              <TableHeader>
                                <FormattedMessage
                                  id="notebook.bioanalytical.storage.retentionEnd"
                                  defaultMessage="Retention End Date"
                                />
                              </TableHeader>
                              <TableHeader>
                                <FormattedMessage
                                  id="notebook.bioanalytical.storage.legalHold"
                          ...
                          <TableBody>
                            {retentionStorage.map((retention, index) => (
                              <TableRow key={index}>
          ...
          {/* Tab 4: Data Archival & Traceability */}
          <TabPanel>
            <div style={{ paddingTop: "1.5rem" }}>
              <Grid>
                <Column lg={16} md={8} sm={4}>
