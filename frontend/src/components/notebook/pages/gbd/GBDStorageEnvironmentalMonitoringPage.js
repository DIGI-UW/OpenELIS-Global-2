...
/**
 * GBDStorageEnvironmentalMonitoringPage - Page 10: Storage & Environmental Monitoring
 *
 ...
 * }
 */
export const GBDStorageEnvironmentalMonitoringPage = ({
  entryId,
  notebookId,
  pageData = {},
  onProgressUpdate,
  ...
  const storageConditionOptions = [
    {
      ...
      label: intl.formatMessage({
        id: "notebook.gbd.storage.condition.frozen20",
    ...
    },
    {
      id: "FROZEN_MINUS80",
      label: intl.formatMessage({
        id: "notebook.gbd.storage.condition.frozen80",
  ...
  const handleOpenStorageModal = useCallback(() => {
    if (selectedSampleIds.length === 0) {
      notify({
        ...
        title: intl.formatMessage({
          id: "notebook.gbd.storage.error.noSample",
    ...
    if (samplesWithStorage.length > 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.gbd.storage.error.alreadyAssigned",
          defaultMessage:
            "Cannot reassign storage to samples that already have a location assigned.",
        }),
        message: intl.formatMessage(
          {
            id: "notebook.gbd.storage.error.alreadyAssignedDetails",
            defaultMessage:
    ...
    (wellCoord, wellInfo) => {
      if (wellInfo && wellInfo.pending === false) {
        notify({
          kind: NotificationKinds.error,
          title: intl.formatMessage({
            id: "notebook.gbd.storage.wellOccupied",
  ...
  const handleSubmitRetrieval = useCallback(() => {
    if (!retrievalData.retrievedBy) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.gbd.storage.retrieval.requiredField",
      ...
      (response) => {
        ...
        if (response?.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.gbd.storage.retrieval.success",
          ...
          notify({
            kind: NotificationKinds.error,
            title: intl.formatMessage({
              id: "notebook.gbd.storage.retrieval.error",
  ...
  const handleSubmitDisposal = useCallback(() => {
    if (!disposalData.disposalMethod) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.gbd.storage.disposal.requiredField",
      ...
      (response) => {
        ...
        if (response?.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.gbd.storage.disposal.success",
          ...
          notify({
            kind: NotificationKinds.error,
            title: intl.formatMessage({
              id: "notebook.gbd.storage.disposal.error",
  ...
  const handleMarkComplete = useCallback(() => {
    ...
    if (samplesToComplete.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.gbd.storage.markComplete.noEligible",
          defaultMessage:
      ...
      (response) => {
        ...
        if (response?.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.gbd.storage.markComplete.success",
                defaultMessage:
          ...
          notify({
            kind: NotificationKinds.error,
            title: intl.formatMessage({
              id: "notebook.gbd.storage.markComplete.error",
  ...
  const handleAssignStorage = useCallback(() => {
    ...
    if (!selectedBox) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.gbd.storage.selectBox",
    ...
    if (!selectedCondition) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.gbd.storage.selectCondition",
    ...
    if (Object.keys(wellAssignments).length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.gbd.storage.assignWells",
      ...
      (response) => {
        ...
        if (response?.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.gbd.storage.assignSuccess",
          ...
          notify({
            ...
            title:
              response?.error ||
              intl.formatMessage({
                id: "notebook.gbd.storage.assignError",
  ...
  return (
    <div className="gbd-storage-monitoring-page">
      <div className="page-section-header">
        <h4>
          <FormattedMessage
            id="notebook.gbd.storage.title"
            defaultMessage="Storage & Environmental Monitoring"
          />
        </h4>
        <p className="page-description">
          <FormattedMessage
            id="notebook.gbd.storage.description"
          ...
          <div className="progress-tiles">
            <Tile className="progress-tile">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.gbd.storage.totalSamples"
            ...
            <Tile className="progress-tile verified">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.gbd.storage.stored"
            ...
            <Tile className="progress-tile">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.gbd.storage.pending"
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          <h5>
            <FormattedMessage
              id="notebook.gbd.storage.sampleList"
        ...
        <div className="sample-grid-container">
          {!loading && samples.length === 0 ? (
            <div className="empty-table-state">
              <p>
                <FormattedMessage
                  id="notebook.gbd.storage.noSamples"
              ...
              columns={[
                ...
                { key: "retentionExpiry", header: "Retention Expiry" },
                {
                  ...
                  header: intl.formatMessage({
                    id: "notebook.gbd.column.workflowStatus",
      ...
      <Modal
        ...
        modalHeading={intl.formatMessage(
          {
            id: "notebook.gbd.storage.assignModal.title",
            defaultMessage: "Assign {count} samples to Storage",
          },
          { count: selectedSampleIds.length },
        )}
        primaryButtonText={intl.formatMessage({
          id: "notebook.gbd.storage.assignModal.assign",
          defaultMessage: "Assign",
        })}
        secondaryButtonText={intl.formatMessage({
          id: "notebook.gbd.storage.assignModal.cancel",
      ...
      >
        <div style={{ marginBottom: "2rem" }}>
          <h5 style={{ marginBottom: "1rem" }}>
            <FormattedMessage
              id="notebook.gbd.storage.selectLocation"
        ...
        {selectedBox && (
          <div style={{ marginBottom: "2rem" }}>
            ...
            >
              <h5>
                <FormattedMessage
                  id="notebook.gbd.storage.boxLayout"
              ...
              >
                <FormattedMessage
                  id="notebook.gbd.storage.autoPopulate"
        ...
        <div style={{ marginBottom: "1rem" }}>
          <Dropdown
            ...
            titleText={intl.formatMessage({
              id: "notebook.gbd.storage.condition",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <NumberInput
            id="retention-years"
            label={intl.formatMessage({
              id: "notebook.gbd.storage.retentionYears",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <DatePickerInput
            ...
            labelText={intl.formatMessage({
              id: "notebook.gbd.storage.dateStored",
      ...
      <Modal
        ...
        modalHeading={
          isBulkRetrieval
            ? intl.formatMessage(
                {
                  id: "notebook.gbd.storage.retrievalModal.bulkTitle",
            ...
            : intl.formatMessage(
                {
                  id: "notebook.gbd.storage.retrievalModal.title",
      ...
      >
        <InlineNotification
          kind="info"
          title={intl.formatMessage({
            id: "notebook.gbd.storage.retrieval.info",
            defaultMessage: "Recovery",
          })}
          subtitle={intl.formatMessage({
            id: "notebook.gbd.storage.retrieval.infoDetails",
            defaultMessage:
        ...
        <div style={{ marginBottom: "1rem" }}>
          <DatePickerInput
            id="date-retrieved"
            labelText={intl.formatMessage({
              id: "notebook.gbd.storage.retrieval.dateRecovered",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <TextInput
            id="retrieved-by"
            labelText={intl.formatMessage({
              id: "notebook.gbd.storage.retrieval.recoveredBy",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <TextInput
            ...
            labelText={intl.formatMessage({
              id: "notebook.gbd.storage.retrieval.signature",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <TextInput
            ...
            labelText={intl.formatMessage({
              id: "notebook.gbd.storage.retrieval.reason",
      ...
      <Modal
        ...
        modalHeading={
          isBulkDisposal
            ? intl.formatMessage(
                {
                  id: "notebook.gbd.storage.disposalModal.bulkTitle",
            ...
            : intl.formatMessage(
                {
                  id: "notebook.gbd.storage.disposalModal.title",
      ...
      >
        <InlineNotification
          kind="error"
          title={intl.formatMessage({
            id: "notebook.gbd.storage.disposal.warning",
            defaultMessage: "Warning: This action cannot be undone",
          })}
          subtitle={intl.formatMessage({
            id: "notebook.gbd.storage.disposal.warningDetails",
            defaultMessage:
        ...
        <div style={{ marginBottom: "1rem" }}>
          <DatePickerInput
            id="disposal-date"
            labelText={intl.formatMessage({
              id: "notebook.gbd.storage.disposal.disposalDate",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <Select
            id="disposal-method"
            labelText={intl.formatMessage({
              id: "notebook.gbd.storage.disposal.method",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <TextInput
            id="disposed-by"
            labelText={intl.formatMessage({
              id: "notebook.gbd.storage.disposal.disposedBy",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <TextArea
            id="disposal-notes"
            labelText={intl.formatMessage({
              id: "notebook.gbd.storage.disposal.notes",
...
export default GBDStorageEnvironmentalMonitoringPage;
