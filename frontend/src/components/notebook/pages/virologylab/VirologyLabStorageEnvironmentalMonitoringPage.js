...
/**
 * VirologyLabStorageEnvironmentalMonitoringPage - Page 10: Storage & Environmental Monitoring
 *
 ...
 * {
 *   stage10: {
 *     storageLocation: "Room A > Freezer-80-A > Shelf 3 > Rack 2 > Box GBD-001",
...
export const VirologyLabStorageEnvironmentalMonitoringPage = ({
  ...
  const storageConditionOptions = [
    {
      ...
      label: intl.formatMessage({
        id: "notebook.virologylab.storage.condition.frozen20",
    ...
    },
    {
      id: "FROZEN_MINUS80",
      label: intl.formatMessage({
        id: "notebook.virologylab.storage.condition.frozen80",
  ...
  const handleOpenStorageModal = useCallback(() => {
    if (selectedSampleIds.length === 0) {
      notify({
        ...
        title: intl.formatMessage({
          id: "notebook.virologylab.storage.error.noSample",
    ...
    if (samplesWithStorage.length > 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.storage.error.alreadyAssigned",
          defaultMessage:
            "Cannot reassign storage to samples that already have a location assigned.",
        }),
        message: intl.formatMessage(
          {
            id: "notebook.virologylab.storage.error.alreadyAssignedDetails",
            defaultMessage:
    ...
    (wellCoord, wellInfo) => {
      if (wellInfo && wellInfo.pending === false) {
        notify({
          kind: NotificationKinds.error,
          title: intl.formatMessage({
            id: "notebook.virologylab.storage.wellOccupied",
  ...
  const handleSubmitRetrieval = useCallback(() => {
    if (!retrievalData.retrievedBy) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.storage.retrieval.requiredField",
      ...
      (response) => {
        ...
        if (response?.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.virologylab.storage.retrieval.success",
          ...
          notify({
            kind: NotificationKinds.error,
            title: intl.formatMessage({
              id: "notebook.virologylab.storage.retrieval.error",
  ...
  const handleSubmitDisposal = useCallback(() => {
    if (!disposalData.disposalMethod) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.storage.disposal.requiredField",
      ...
      (response) => {
        ...
        if (response?.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.virologylab.storage.disposal.success",
          ...
          notify({
            kind: NotificationKinds.error,
            title: intl.formatMessage({
              id: "notebook.virologylab.storage.disposal.error",
  ...
  const handleMarkComplete = useCallback(() => {
    ...
    if (samplesToComplete.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.storage.markComplete.noEligible",
          defaultMessage:
      ...
      (response) => {
        ...
        if (response?.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.virologylab.storage.markComplete.success",
                defaultMessage:
          ...
          notify({
            kind: NotificationKinds.error,
            title: intl.formatMessage({
              id: "notebook.virologylab.storage.markComplete.error",
  ...
  const handleAssignStorage = useCallback(() => {
    ...
    if (!selectedBox) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.storage.selectBox",
    ...
    if (!selectedCondition) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.storage.selectCondition",
    ...
    if (Object.keys(wellAssignments).length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.storage.assignWells",
      ...
      (response) => {
        ...
        if (response?.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.virologylab.storage.assignSuccess",
          ...
          notify({
            ...
            title:
              response?.error ||
              intl.formatMessage({
                id: "notebook.virologylab.storage.assignError",
  ...
  return (
    <div className="virologylab-storage-monitoring-page">
      <div className="page-section-header">
        <h4>
          <FormattedMessage
            id="notebook.virologylab.storage.title"
            defaultMessage="Storage & Environmental Monitoring"
          />
        </h4>
        <p className="page-description">
          <FormattedMessage
            id="notebook.virologylab.storage.description"
          ...
          <div className="progress-tiles">
            <Tile className="progress-tile">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.virologylab.storage.totalSamples"
            ...
            <Tile className="progress-tile verified">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.virologylab.storage.stored"
            ...
            <Tile className="progress-tile">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.virologylab.storage.pending"
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          <h5>
            <FormattedMessage
              id="notebook.virologylab.storage.sampleList"
        ...
        <div className="sample-grid-container">
          {!loading && samples.length === 0 ? (
            <div className="empty-table-state">
              <p>
                <FormattedMessage
                  id="notebook.virologylab.storage.noSamples"
            ...
            <SampleGrid
              gridId="virologylab-storage-monitoring"
              samples={samples}
              ...
              columns={[
                ...
                { key: "retentionExpiry", header: "Retention Expiry" },
                {
                  ...
                  header: intl.formatMessage({
                    id: "notebook.virologylab.column.workflowStatus",
      ...
      <Modal
        ...
        modalHeading={intl.formatMessage(
          {
            id: "notebook.virologylab.storage.assignModal.title",
            defaultMessage: "Assign {count} samples to Storage",
          },
          { count: selectedSampleIds.length },
        )}
        primaryButtonText={intl.formatMessage({
          id: "notebook.virologylab.storage.assignModal.assign",
          defaultMessage: "Assign",
        })}
        secondaryButtonText={intl.formatMessage({
          id: "notebook.virologylab.storage.assignModal.cancel",
      ...
      >
        <div style={{ marginBottom: "2rem" }}>
          <h5 style={{ marginBottom: "1rem" }}>
            <FormattedMessage
              id="notebook.virologylab.storage.selectLocation"
        ...
        {selectedBox && (
          <div style={{ marginBottom: "2rem" }}>
            ...
            >
              <h5>
                <FormattedMessage
                  id="notebook.virologylab.storage.boxLayout"
              ...
              >
                <FormattedMessage
                  id="notebook.virologylab.storage.autoPopulate"
        ...
        <div style={{ marginBottom: "1rem" }}>
          <Dropdown
            ...
            titleText={intl.formatMessage({
              id: "notebook.virologylab.storage.condition",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <NumberInput
            id="retention-years"
            label={intl.formatMessage({
              id: "notebook.virologylab.storage.retentionYears",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <DatePickerInput
            ...
            labelText={intl.formatMessage({
              id: "notebook.virologylab.storage.dateStored",
      ...
      <Modal
        ...
        modalHeading={
          isBulkRetrieval
            ? intl.formatMessage(
                {
                  id: "notebook.virologylab.storage.retrievalModal.bulkTitle",
            ...
            : intl.formatMessage(
                {
                  id: "notebook.virologylab.storage.retrievalModal.title",
      ...
      >
        <InlineNotification
          kind="info"
          title={intl.formatMessage({
            id: "notebook.virologylab.storage.retrieval.info",
            defaultMessage: "Recovery",
          })}
          subtitle={intl.formatMessage({
            id: "notebook.virologylab.storage.retrieval.infoDetails",
            defaultMessage:
        ...
        <div style={{ marginBottom: "1rem" }}>
          <DatePickerInput
            id="date-retrieved"
            labelText={intl.formatMessage({
              id: "notebook.virologylab.storage.retrieval.dateRecovered",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <TextInput
            id="retrieved-by"
            labelText={intl.formatMessage({
              id: "notebook.virologylab.storage.retrieval.recoveredBy",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <TextInput
            ...
            labelText={intl.formatMessage({
              id: "notebook.virologylab.storage.retrieval.signature",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <TextInput
            ...
            labelText={intl.formatMessage({
              id: "notebook.virologylab.storage.retrieval.reason",
      ...
      <Modal
        ...
        modalHeading={
          isBulkDisposal
            ? intl.formatMessage(
                {
                  id: "notebook.virologylab.storage.disposalModal.bulkTitle",
            ...
            : intl.formatMessage(
                {
                  id: "notebook.virologylab.storage.disposalModal.title",
      ...
      >
        <InlineNotification
          kind="error"
          title={intl.formatMessage({
            id: "notebook.virologylab.storage.disposal.warning",
            defaultMessage: "Warning: This action cannot be undone",
          })}
          subtitle={intl.formatMessage({
            id: "notebook.virologylab.storage.disposal.warningDetails",
            defaultMessage:
        ...
        <div style={{ marginBottom: "1rem" }}>
          <DatePickerInput
            id="disposal-date"
            labelText={intl.formatMessage({
              id: "notebook.virologylab.storage.disposal.disposalDate",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <Select
            id="disposal-method"
            labelText={intl.formatMessage({
              id: "notebook.virologylab.storage.disposal.method",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <TextInput
            id="disposed-by"
            labelText={intl.formatMessage({
              id: "notebook.virologylab.storage.disposal.disposedBy",
        ...
        <div style={{ marginBottom: "1rem" }}>
          <TextArea
            id="disposal-notes"
            labelText={intl.formatMessage({
              id: "notebook.virologylab.storage.disposal.notes",
