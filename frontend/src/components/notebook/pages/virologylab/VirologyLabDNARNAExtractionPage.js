...
export const VirologyLabDNARNAExtractionPage = ({
    ...
    if (selectedSampleIds.length === 0) {
      notify({
        ...
        title: intl.formatMessage({
          id: "notebook.virologylab.extraction.error.noSample",
  ...
  const applyExtraction = useCallback(() => {
    ...
    if (!methodKit) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.extraction.error.requiredFields",
          defaultMessage: "Required Field Missing",
        }),
        message: intl.formatMessage({
          id: "notebook.virologylab.extraction.error.methodKitRequired",
    ...
    if (!lotNumbers || lotNumbers.trim() === "") {
      notify({
        ...
        message: intl.formatMessage({
          id: "notebook.virologylab.extraction.error.lotNumbersRequired",
    ...
    if (!operator || operator.trim() === "") {
      notify({
        ...
        message: intl.formatMessage({
          id: "notebook.virologylab.extraction.error.operatorRequired",
    ...
    if (!hasRealPageId) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.extraction.error.noPage",
          defaultMessage:
            ...
            (statusCode) => {
              if (statusCode === 200) {
                notify({
                  ...
                  title: intl.formatMessage(
                    {
                      id: "notebook.virologylab.extraction.success",
                ...
                notify({
                  kind: NotificationKinds.error,
                  title: intl.formatMessage({
                    id: "notebook.virologylab.extraction.error.statusUpdate",
                    defaultMessage:
  ...
  const handleMarkComplete = useCallback(() => {
    ...
    if (samplesToComplete.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.extraction.noEligibleSamples",
          defaultMessage:
      ...
      (response) => {
        ...
        if (response && response.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.virologylab.extraction.completeSuccess",
                defaultMessage:
          ...
          notify({
            ...
            title:
              response?.error ||
              intl.formatMessage({
                id: "notebook.virologylab.extraction.completeFailed",
  ...
  const { openSignatureModal, signatureModalProps, isCheckingEnabled } =
    useESign({
      ...
      context: intl.formatMessage({
        id: "notebook.virologylab.extraction.esig.authoredContext",
  ...
  const {
    ...
    context: intl.formatMessage({
      id: "notebook.virologylab.extraction.esig.completeContext",
  ...
  return (
    <div className="virologylab-dna-rna-extraction-page">
      <div className="page-section-header">
        ...
        <p className="page-description">
          <FormattedMessage
            id="notebook.virologylab.extraction.description"
          ...
          <div className="progress-tiles">
            <Tile className="progress-tile">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.virologylab.extraction.ready"
            ...
            <Tile className="progress-tile verified">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.virologylab.extraction.extracted"
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          <h5>
            <FormattedMessage
              id="notebook.virologylab.extraction.ready.title"
        ...
        <div className="sample-grid-container">
          {!loading && readyForExtractionSamples.length === 0 ? (
            <div className="empty-table-state">
              <p>
                <FormattedMessage
                  id="notebook.virologylab.extraction.ready.empty"
            ...
            <SampleGrid
              gridId="virologylab-extraction-ready"
      ...
      {extractionCompletedSamples.length > 0 && (
        <div className="sample-table-section">
          <div className="table-section-header">
            <h5>
              <FormattedMessage
                id="notebook.virologylab.extraction.completed.title"
          ...
          <div className="sample-grid-container">
            <SampleGrid
              gridId="virologylab-extraction-completed"
      ...
      <Modal
        ...
        modalHeading={intl.formatMessage({
          id: "notebook.virologylab.extraction.modal.title",
        ...
        <Grid narrow>
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <Dropdown
              ...
              titleText={intl.formatMessage({
                id: "notebook.virologylab.extraction.methodKit",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.virologylab.extraction.lotNumbers",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="operator"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.extraction.operator",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              id="dateTime"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.extraction.dateTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextArea
              id="notes"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.extraction.notes",
