...
/**
 * VirologyLabPCRAmplificationPage - Page 4: PCR Amplification
 *
...
export const VirologyLabPCRAmplificationPage = ({
    ...
    if (selectedSampleIds.length === 0) {
      notify({
        ...
        title: intl.formatMessage({
          id: "notebook.virologylab.pcr.error.noSample",
  ...
  const applyPCR = useCallback(() => {
    if (!pcrType) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.pcr.error.requiredFields",
          defaultMessage: "Required Field Missing",
        }),
        message: intl.formatMessage({
          id: "notebook.virologylab.pcr.error.typeRequired",
    ...
    if (!hasRealPageId) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.pcr.error.noPage",
          defaultMessage:
            ...
            (statusCode) => {
              if (statusCode === 200) {
                notify({
                  ...
                  title: intl.formatMessage(
                    {
                      id: "notebook.virologylab.pcr.success",
                      defaultMessage:
                ...
                notify({
                  kind: NotificationKinds.error,
                  title: intl.formatMessage({
                    id: "notebook.virologylab.pcr.error.statusUpdate",
                    defaultMessage:
  ...
  const handleMarkComplete = useCallback(() => {
    ...
    if (samplesToComplete.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.pcr.noEligibleSamples",
          defaultMessage:
      ...
      (response) => {
        ...
        if (response && response.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.virologylab.pcr.completeSuccess",
                defaultMessage:
          ...
          notify({
            ...
            title:
              response?.error ||
              intl.formatMessage({
                id: "notebook.virologylab.pcr.completeFailed",
  ...
  const { openSignatureModal, signatureModalProps, isCheckingEnabled } =
    useESign({
      ...
      context: intl.formatMessage({
        id: "notebook.virologylab.pcr.esig.authoredContext",
  ...
  const {
    ...
    context: intl.formatMessage({
      id: "notebook.virologylab.pcr.esig.completeContext",
  ...
  return (
    <div className="virologylab-pcr-amplification-page">
      <div className="page-section-header">
        <h4>
          <FormattedMessage
            id="notebook.virologylab.pcr.title"
            defaultMessage="PCR Amplification"
          />
        </h4>
        <p className="page-description">
          <FormattedMessage
            id="notebook.virologylab.pcr.description"
          ...
          <div className="progress-tiles">
            <Tile className="progress-tile">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.virologylab.pcr.ready"
            ...
            <Tile className="progress-tile verified">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.virologylab.pcr.amplified"
      ...
      <div className="page-actions-bar">
        <PermissionGate permission={Permissions.UPDATE_SAMPLES}>
          ...
          >
            <FormattedMessage
              id="notebook.virologylab.recordPCR"
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          <h5>
            <FormattedMessage
              id="notebook.virologylab.pcr.ready.title"
        ...
        <div className="sample-grid-container">
          {!loading && readyForPCRSamples.length === 0 ? (
            <div className="empty-table-state">
              <p>
                <FormattedMessage
                  id="notebook.virologylab.pcr.ready.empty"
      ...
      {pcrCompletedSamples.length > 0 && (
        <div className="sample-table-section">
          <div className="table-section-header">
            <h5>
              <FormattedMessage
                id="notebook.virologylab.pcr.completed.title"
          ...
          <div className="sample-grid-container">
            <SampleGrid
              gridId="virologylab-pcr-completed"
      ...
      <Modal
        ...
        modalHeading={intl.formatMessage({
          id: "notebook.virologylab.pcr.modal.title",
        ...
        <Grid narrow>
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <Dropdown
              ...
              titleText={intl.formatMessage({
                id: "notebook.virologylab.pcr.type",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              ...
              label={intl.formatMessage({
                id: "notebook.virologylab.pcr.expectedBandSize",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <Dropdown
              id="primers"
              titleText={intl.formatMessage({
                id: "notebook.virologylab.pcr.primers",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <Dropdown
              id="protocol"
              titleText={intl.formatMessage({
                id: "notebook.virologylab.pcr.protocol",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextArea
              ...
              labelText={intl.formatMessage({
                id: "notebook.virologylab.pcr.cyclingConditions",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            ...
            >
              ...
              >
                <FormattedMessage
                  id="notebook.virologylab.pcr.controls"
              ...
              <div style={{ marginBottom: "1rem" }}>
                <Checkbox
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.pcr.positiveControlPresent",
                ...
                <>
                  <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                    <NumberInput
                      ...
                      label={intl.formatMessage({
                        id: "notebook.virologylab.pcr.positiveControlBandSize",
                  ...
                  >
                    <TextArea
                      ...
                      labelText={intl.formatMessage({
                        id: "notebook.virologylab.pcr.positiveControlNotes",
              ...
              <div style={{ marginBottom: "1rem" }}>
                <Checkbox
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.pcr.negativeControlPresent",
                ...
                <>
                  <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                    <Dropdown
                      ...
                      titleText={intl.formatMessage({
                        id: "notebook.virologylab.pcr.negativeControlResult",
                  ...
                  >
                    <TextArea
                      ...
                      labelText={intl.formatMessage({
                        id: "notebook.virologylab.pcr.negativeControlNotes",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="operator"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.pcr.operator",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              id="pcr-dateTime"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.pcr.dateTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextArea
              id="pcr-notes"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.pcr.notes",
