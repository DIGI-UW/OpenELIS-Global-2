...
/**
 * VirologyLabBioinformaticsAnalysisPage - Page 9: Bioinformatics Analysis & Data Submission
 *
...
export const VirologyLabBioinformaticsAnalysisPage = ({
    ...
    if (selectedSampleIds.length === 0) {
      notify({
        ...
        title: intl.formatMessage({
          id: "notebook.virologylab.bioinformatics.error.noSample",
  ...
  const applyAnalysis = useCallback(() => {
    ...
    if (!fastqTransferred && analysisTypes.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.bioinformatics.error.requiredFields",
          defaultMessage: "Required Field Missing",
        }),
        message: intl.formatMessage({
          id: "notebook.virologylab.bioinformatics.error.dataRequired",
          defaultMessage:
    ...
    if (!hasRealPageId) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.bioinformatics.error.noPage",
          defaultMessage:
            ...
            (statusCode) => {
              if (statusCode === 200) {
                notify({
                  ...
                  title: intl.formatMessage(
                    {
                      id: "notebook.virologylab.bioinformatics.success",
                      defaultMessage:
                ...
                notify({
                  kind: NotificationKinds.error,
                  title: intl.formatMessage({
                    id: "notebook.virologylab.bioinformatics.error.statusUpdate",
                    defaultMessage:
  ...
  const handleMarkComplete = useCallback(() => {
    ...
    if (samplesToComplete.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.bioinformatics.noEligibleSamples",
          defaultMessage:
      ...
      (response) => {
        ...
        if (response && response.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.virologylab.bioinformatics.completeSuccess",
                defaultMessage:
          ...
          notify({
            ...
            title:
              response?.error ||
              intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.completeFailed",
  ...
  const renderReviewStatus = (sample) => {
    ...
    if (finalCompleted) {
      return (
        <Tag type="green" size="sm" renderIcon={CheckmarkFilled}>
          <FormattedMessage
            id="notebook.virologylab.bioinformatics.fullyApproved"
    ...
    if (bioCompleted) {
      return (
        <Tag type="blue" size="sm">
          <FormattedMessage
            id="notebook.virologylab.bioinformatics.bioApproved"
    ...
    if (primaryCompleted) {
      return (
        <Tag type="blue" size="sm">
          <FormattedMessage
            id="notebook.virologylab.bioinformatics.primaryApproved"
    ...
    return (
      <Tag type="gray" size="sm">
        <FormattedMessage
          id="notebook.virologylab.bioinformatics.reviewPending"
  ...
  return (
    <div className="virologylab-bioinformatics-analysis-page">
      <div className="page-section-header">
        ...
        <p className="page-description">
          <FormattedMessage
            id="notebook.virologylab.bioinformatics.description"
          ...
          <div className="progress-tiles">
            <Tile className="progress-tile">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.virologylab.bioinformatics.ready"
            ...
            <Tile className="progress-tile verified">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.virologylab.bioinformatics.completed"
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          <h5>
            <FormattedMessage
              id="notebook.virologylab.bioinformatics.ready.title"
        ...
        <div className="sample-grid-container">
          {!loading && readyForAnalysisSamples.length === 0 ? (
            <div className="empty-table-state">
              <p>
                <FormattedMessage
                  id="notebook.virologylab.bioinformatics.ready.empty"
            ...
            <SampleGrid
              gridId="virologylab-bioinformatics-ready"
      ...
      {analysisCompletedSamples.length > 0 && (
        <div className="sample-table-section">
          <div className="table-section-header">
            <h5>
              <FormattedMessage
                id="notebook.virologylab.bioinformatics.completed.title"
          ...
          <div className="sample-grid-container">
            <SampleGrid
              gridId="virologylab-bioinformatics-completed"
        ...
        <Grid narrow>
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1.5rem" }}>
            ...
            >
              <p style={{ margin: 0, fontSize: "0.875rem", color: "#333" }}>
                <strong>
                  <FormattedMessage
                    id="notebook.virologylab.bioinformatics.instructions"
                    defaultMessage="STAGE 9: Bioinformatics Analysis & Data Submission"
                  />
                </strong>
                <br />
                <FormattedMessage
                  id="notebook.virologylab.bioinformatics.description.detailed"
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <Checkbox
              ...
              labelText={intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.fastqTransferred",
                defaultMessage:
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <Dropdown
              ...
              titleText={intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.dataRepository",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <div style={{ marginBottom: "0.5rem" }}>
              ...
              >
                <FormattedMessage
                  id="notebook.virologylab.bioinformatics.analysisTypes"
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <div style={{ marginBottom: "0.5rem" }}>
              ...
              >
                <FormattedMessage
                  id="notebook.virologylab.bioinformatics.resultsSubmitted"
              ...
              <Checkbox
                id="vcf-submitted"
                labelText={intl.formatMessage({
                  id: "notebook.virologylab.bioinformatics.vcfSubmitted",
              ...
              <Checkbox
                id="bam-submitted"
                labelText={intl.formatMessage({
                  id: "notebook.virologylab.bioinformatics.bamSubmitted",
              ...
              <Checkbox
                ...
                labelText={intl.formatMessage({
                  id: "notebook.virologylab.bioinformatics.reportsSubmitted",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="report-url"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.reportUrl",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextArea
              id="results-summary"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.resultsSummary",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="analyst"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.analyst",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.dateTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextArea
              ...
              labelText={intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.notes",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6 style={{ marginBottom: "1rem", marginTop: "1rem" }}>
              <FormattedMessage
                id="notebook.virologylab.bioinformatics.auditTrail"
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="recorded-by"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.recordedBy",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              id="recorded-date"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.recordedDate",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="recorded-time"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.recordedTime",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="last-modified-by"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.lastModifiedBy",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.lastModifiedDate",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.virologylab.bioinformatics.lastModifiedTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6 style={{ marginBottom: "1rem", marginTop: "1rem" }}>
              <FormattedMessage
                id="notebook.virologylab.bioinformatics.reviewWorkflow"
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.virologylab.bioinformatics.primaryReview"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="primary-reviewer"
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.bioinformatics.primaryReviewer",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.bioinformatics.primaryReviewDate",
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.bioinformatics.primaryReviewTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.virologylab.bioinformatics.bioinformaticsReview"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="bio-reviewer"
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.bioinformatics.bioReviewer",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  id="bio-review-date"
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.bioinformatics.bioReviewDate",
                    defaultMessage: "Review Date",
                  })}
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="bio-review-time"
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.bioinformatics.bioReviewTime",
                    defaultMessage: "Review Time",
                  })}
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.virologylab.bioinformatics.finalApproval"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="final-approver"
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.bioinformatics.finalApprover",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.bioinformatics.finalApprovalDate",
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.bioinformatics.finalApprovalTime",
