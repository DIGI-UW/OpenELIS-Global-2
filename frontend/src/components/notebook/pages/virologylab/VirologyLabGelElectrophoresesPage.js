...
/**
 * VirologyLabGelElectrophoresesPage - Page 5: Gel Electrophoresis
 *
...
export const VirologyLabGelElectrophoresesPage = ({
    ...
    if (selectedSampleIds.length === 0) {
      notify({
        ...
        title: intl.formatMessage({
          id: "notebook.virologylab.gel.error.noSample",
    ...
    (files) => {
      ...
      if (!isValidType) {
        notify({
          kind: NotificationKinds.error,
          title: intl.formatMessage({
            id: "notebook.virologylab.gel.error.invalidFileType",
            defaultMessage: "Invalid File Type",
          }),
          message: intl.formatMessage({
            id: "notebook.virologylab.gel.error.imageRequired",
            defaultMessage:
      ...
      if (file.size > maxSizeBytes) {
        notify({
          kind: NotificationKinds.error,
          title: intl.formatMessage({
            id: "notebook.virologylab.gel.error.fileTooLarge",
            defaultMessage: "File Too Large",
          }),
          message: intl.formatMessage({
            id: "notebook.virologylab.gel.error.fileSizeLimit",
        ...
        (response) => {
          ...
          if (response?.success || response?.filePath) {
            ...
            notify({
              ...
              title: intl.formatMessage({
                id: "notebook.virologylab.gel.imageUploaded",
                defaultMessage: "Image Uploaded Successfully",
              }),
              message: intl.formatMessage(
                {
                  id: "notebook.virologylab.gel.imageUploadedMessage",
                  defaultMessage:
            ...
            notify({
              kind: NotificationKinds.error,
              title: intl.formatMessage({
                id: "notebook.virologylab.gel.error.imageUploadFailed",
                defaultMessage: "Image Upload Failed",
              }),
              message: intl.formatMessage({
                id: "notebook.virologylab.gel.error.tryAgain",
  ...
  const applyGel = useCallback(() => {
    if (!gelType) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.gel.error.requiredFields",
          defaultMessage: "Required Field Missing",
        }),
        message: intl.formatMessage({
          id: "notebook.virologylab.gel.error.typeRequired",
    ...
    if (!integrityStatus) {
      notify({
        ...
        message: intl.formatMessage({
          id: "notebook.virologylab.gel.error.integrityRequired",
    ...
    if (!hasRealPageId) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.gel.error.noPage",
          defaultMessage:
            ...
            (statusCode) => {
              if (statusCode === 200) {
                notify({
                  ...
                  title: intl.formatMessage(
                    {
                      id: "notebook.virologylab.gel.success",
                      defaultMessage:
                ...
                notify({
                  kind: NotificationKinds.error,
                  title: intl.formatMessage({
                    id: "notebook.virologylab.gel.error.statusUpdate",
                    defaultMessage:
  ...
  const handleMarkComplete = useCallback(() => {
    ...
    if (samplesToComplete.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.gel.noEligibleSamples",
          defaultMessage:
      ...
      (response) => {
        ...
        if (response && response.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.virologylab.gel.completeSuccess",
                defaultMessage:
          ...
          notify({
            ...
            title:
              response?.error ||
              intl.formatMessage({
                id: "notebook.virologylab.gel.completeFailed",
  ...
  const renderIntegrityStatus = (sample) => {
    ...
    if (!status) {
      return (
        <Tag type="gray" size="sm">
          <FormattedMessage
            id="notebook.virologylab.gel.notRecorded"
    ...
    if (status === "pass") {
      return (
        <Tag type="green" size="sm" renderIcon={CheckmarkFilled}>
          <FormattedMessage
            id="notebook.virologylab.gel.pass"
            defaultMessage="PASS"
          />
        </Tag>
      );
    ...
    return (
      <Tag type="red" size="sm">
        <FormattedMessage
          id="notebook.virologylab.gel.fail"
          defaultMessage="FAIL"
        />
      </Tag>
    );
  ...
  const renderReviewStatus = (sample) => {
    ...
    if (finalCompleted) {
      return (
        <Tag type="green" size="sm" renderIcon={CheckmarkFilled}>
          <FormattedMessage
            id="notebook.virologylab.gel.fullyApproved"
    ...
    if (bioCompleted) {
      return (
        <Tag type="blue" size="sm">
          <FormattedMessage
            id="notebook.virologylab.gel.bioApproved"
    ...
    if (primaryCompleted) {
      return (
        <Tag type="blue" size="sm">
          <FormattedMessage
            id="notebook.virologylab.gel.primaryApproved"
    ...
    return (
      <Tag type="gray" size="sm">
        <FormattedMessage
          id="notebook.virologylab.gel.reviewPending"
  ...
  return (
    <div className="virologylab-gel-electrophoresis-page">
      <div className="page-section-header">
        <h4>
          <FormattedMessage
            id="notebook.virologylab.gel.title"
            defaultMessage="Gel Electrophoresis"
          />
        </h4>
        <p className="page-description">
          <FormattedMessage
            id="notebook.virologylab.gel.description"
          ...
          <div className="progress-tiles">
            <Tile className="progress-tile">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.virologylab.gel.ready"
            ...
            <Tile className="progress-tile verified">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.virologylab.gel.analyzed"
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          <h5>
            <FormattedMessage
              id="notebook.virologylab.gel.ready.title"
        ...
        <div className="sample-grid-container">
          {!loading && readyForGelSamples.length === 0 ? (
            <div className="empty-table-state">
              <p>
                <FormattedMessage
                  id="notebook.virologylab.gel.ready.empty"
      ...
      {gelCompletedSamples.length > 0 && (
        <div className="sample-table-section">
          <div className="table-section-header">
            <h5>
              <FormattedMessage
                id="notebook.virologylab.gel.completed.title"
          ...
          <div className="sample-grid-container">
            <SampleGrid
              gridId="virologylab-gel-completed"
        ...
        <Grid narrow>
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <Dropdown
              ...
              titleText={intl.formatMessage({
                id: "notebook.virologylab.gel.type",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              ...
              label={intl.formatMessage({
                id: "notebook.virologylab.gel.productSize",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              id="concentration"
              label={intl.formatMessage({
                id: "notebook.virologylab.gel.concentration",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <Dropdown
              id="quality"
              titleText={intl.formatMessage({
                id: "notebook.virologylab.gel.quality",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <Dropdown
              id="integrity-status"
              titleText={intl.formatMessage({
                id: "notebook.virologylab.gel.integrityStatus",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.virologylab.gel.operator",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              id="gel-dateTime"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.gel.dateTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <div style={{ marginBottom: "1rem" }}>
              <p style={{ marginBottom: "0.5rem", fontWeight: "bold" }}>
                <FormattedMessage
                  id="notebook.virologylab.gel.image"
              ...
              <FileUploaderDropContainer
                ...
                name="gelImage"
                labelText={intl.formatMessage({
                  id: "notebook.virologylab.gel.imageDrop",
                  defaultMessage:
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextArea
              id="gel-notes"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.gel.notes",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6 style={{ marginBottom: "1rem", marginTop: "1rem" }}>
              <FormattedMessage
                id="notebook.virologylab.gel.auditTrail"
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="recorded-by"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.gel.recordedBy",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              id="recorded-date"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.gel.recordedDate",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="recorded-time"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.gel.recordedTime",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              id="last-modified-by"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.gel.lastModifiedBy",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.virologylab.gel.lastModifiedDate",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.virologylab.gel.lastModifiedTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6 style={{ marginBottom: "1rem", marginTop: "1rem" }}>
              <FormattedMessage
                id="notebook.virologylab.gel.reviewWorkflow"
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.virologylab.gel.primaryReview"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="primary-reviewer"
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.gel.primaryReviewer",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.gel.primaryReviewDate",
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.gel.primaryReviewTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.virologylab.gel.bioinformaticsReview"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="bio-reviewer"
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.gel.bioReviewer",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  id="bio-review-date"
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.gel.bioReviewDate",
                    defaultMessage: "Review Date",
                  })}
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="bio-review-time"
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.gel.bioReviewTime",
                    defaultMessage: "Review Time",
                  })}
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "0.5rem" }}>
            <div>
              ...
              >
                ...
                <span>
                  <FormattedMessage
                    id="notebook.virologylab.gel.finalApproval"
            ...
            <>
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  id="final-approver"
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.gel.finalApprover",
              ...
              <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
                <DatePickerInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.gel.finalApprovalDate",
              ...
              <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
                <TextInput
                  ...
                  labelText={intl.formatMessage({
                    id: "notebook.virologylab.gel.finalApprovalTime",
