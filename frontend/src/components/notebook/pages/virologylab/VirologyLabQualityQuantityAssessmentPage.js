...
/**
 * VirologyLabQualityQuantityAssessmentPage - Page 3: Quality & Quantity Assessment
 *
...
export const VirologyLabQualityQuantityAssessmentPage = ({
    ...
    if (selectedSampleIds.length === 0) {
      notify({
        ...
        title: intl.formatMessage({
          id: "notebook.virologylab.qc.error.noSample",
  ...
  const applyQC = useCallback(() => {
    ...
    if (
      ...
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.qc.error.requiredFields",
          defaultMessage: "Required Field Missing",
        }),
        message: intl.formatMessage({
          id: "notebook.virologylab.qc.error.atLeastOneQC",
          defaultMessage:
    ...
    if (!hasRealPageId) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.qc.error.noPage",
          defaultMessage:
            ...
            (statusCode) => {
              if (statusCode === 200) {
                notify({
                  ...
                  title: intl.formatMessage(
                    {
                      id: "notebook.virologylab.qc.success",
                      defaultMessage:
                ...
                notify({
                  kind: NotificationKinds.error,
                  title: intl.formatMessage({
                    id: "notebook.virologylab.qc.error.statusUpdate",
                    defaultMessage:
  ...
  const handleMarkComplete = useCallback(() => {
    ...
    if (samplesToComplete.length === 0) {
      notify({
        kind: NotificationKinds.error,
        title: intl.formatMessage({
          id: "notebook.virologylab.qc.noEligibleSamples",
          defaultMessage:
      ...
      (response) => {
        ...
        if (response && response.success) {
          notify({
            ...
            title: intl.formatMessage(
              {
                id: "notebook.virologylab.qc.completeSuccess",
                defaultMessage:
          ...
          notify({
            ...
            title:
              response?.error ||
              intl.formatMessage({
                id: "notebook.virologylab.qc.completeFailed",
  ...
  const { openSignatureModal, signatureModalProps, isCheckingEnabled } =
    useESign({
      ...
      context: intl.formatMessage({
        id: "notebook.virologylab.qc.esig.authoredContext",
  ...
  const {
    ...
    context: intl.formatMessage({
      id: "notebook.virologylab.qc.esig.completeContext",
  ...
  const renderQCStatus = (sample) => {
    ...
    if (!qcStatus) {
      return (
        <Tag type="gray" size="sm">
          <FormattedMessage
            id="notebook.virologylab.qc.status.notRecorded"
    ...
    if (qcStatus === "PASS") {
      return (
        <Tag type="green" size="sm" renderIcon={CheckmarkFilled}>
          <FormattedMessage
            id="notebook.virologylab.qc.status.pass"
            defaultMessage="PASS"
          />
        </Tag>
      );
    ...
    return (
      <Tag type="red" size="sm">
        <FormattedMessage
          id="notebook.virologylab.qc.status.fail"
          defaultMessage="FAIL"
        />
      </Tag>
    );
  ...
  return (
    <div className="virologylab-qc-assessment-page">
      <div className="page-section-header">
        <h4>
          <FormattedMessage
            id="notebook.virologylab.qc.title"
            defaultMessage="Quality & Quantity Assessment"
          />
        </h4>
        <p className="page-description">
          <FormattedMessage
            id="notebook.virologylab.qc.description"
      ...
      <InlineNotification
        kind="info"
        title={intl.formatMessage({
          id: "notebook.virologylab.qc.criteria.title",
          defaultMessage: "QC Pass/Fail Criteria",
        })}
        subtitle={intl.formatMessage({
          id: "notebook.virologylab.qc.criteria.explanation",
          defaultMessage:
          ...
          <div className="progress-tiles">
            <Tile className="progress-tile">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.virologylab.qc.ready"
            ...
            <Tile className="progress-tile verified">
              <span className="progress-label">
                <FormattedMessage
                  id="notebook.virologylab.qc.assessed"
      ...
      <div className="page-actions-bar">
        <PermissionGate permission={Permissions.UPDATE_SAMPLES}>
          ...
          >
            <FormattedMessage
              id="notebook.virologylab.recordQC"
      ...
      <div className="sample-table-section">
        <div className="table-section-header">
          <h5>
            <FormattedMessage
              id="notebook.virologylab.qc.ready.title"
        ...
        <div className="sample-grid-container">
          {!loading && readyForQCSamples.length === 0 ? (
            <div className="empty-table-state">
              <p>
                <FormattedMessage
                  id="notebook.virologylab.qc.ready.empty"
              ...
              columns={[
                ...
                },
                {
                  ...
                  header: intl.formatMessage({
                    id: "notebook.virologylab.qc.column.qcStatus",
      ...
      {qcCompletedSamples.length > 0 && (
        <div className="sample-table-section">
          <div className="table-section-header">
            <h5>
              <FormattedMessage
                id="notebook.virologylab.qc.completed.title"
          ...
          <div className="sample-grid-container">
            <SampleGrid
              gridId="virologylab-qc-completed"
      ...
      <Modal
        ...
        modalHeading={intl.formatMessage({
          id: "notebook.virologylab.qc.modal.title",
      ...
      >
        ...
        <Grid narrow>
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1.5rem" }}>
            ...
            >
              <p style={{ margin: 0, fontSize: "0.875rem", color: "#333" }}>
                <strong>
                  <FormattedMessage
                    id="notebook.virologylab.qc.instructions"
                    defaultMessage="STAGE 3: Quality & Quantity Assessment"
                  />
                </strong>
                <br />
                <FormattedMessage
                  id="notebook.virologylab.qc.description.detailed"
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6>
              <FormattedMessage
                id="notebook.virologylab.qc.section.nanodrop"
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              ...
              label={intl.formatMessage({
                id: "notebook.virologylab.qc.nanodrop.concentration",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              id="a260-280"
              label={intl.formatMessage({
                id: "notebook.virologylab.qc.a260.280",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              id="a260-230"
              label={intl.formatMessage({
                id: "notebook.virologylab.qc.a260.230",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6>
              <FormattedMessage
                id="notebook.virologylab.qc.section.qubit"
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              ...
              label={intl.formatMessage({
                id: "notebook.virologylab.qc.qubit.concentration",
                defaultMessage: "Concentration (ng/µL)",
              })}
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <h6>
              <FormattedMessage
                id="notebook.virologylab.qc.section.bioanalyzer"
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              id="rin"
              label={intl.formatMessage({
                id: "notebook.virologylab.qc.bioanalyzer.rin",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <NumberInput
              id="fragment-size"
              label={intl.formatMessage({
                id: "notebook.virologylab.qc.bioanalyzer.fragmentSize",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <TextInput
              ...
              labelText={intl.formatMessage({
                id: "notebook.virologylab.qc.operator",
          ...
          <Column lg={8} md={8} sm={4} style={{ marginBottom: "1rem" }}>
            <DatePickerInput
              id="qc-dateTime"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.qc.dateTime",
          ...
          <Column lg={16} md={16} sm={4} style={{ marginBottom: "1rem" }}>
            <TextArea
              id="qc-notes"
              labelText={intl.formatMessage({
                id: "notebook.virologylab.qc.notes",
