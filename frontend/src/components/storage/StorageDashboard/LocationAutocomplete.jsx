    ...
    getFromOpenElisServer(
      ...
      (results) => {
        ...
        if (process.env.NODE_ENV === 'development') {
          console.log('[LocationAutocomplete] Raw API response:', JSON.stringify((results || []).slice(0, 2), null, 2));
        }
        ...
        if (process.env.NODE_ENV === 'development') {
          console.log('[LocationAutocomplete] Filtered results:', JSON.stringify(filteredResults.slice(0, 2), null, 2));
        }
