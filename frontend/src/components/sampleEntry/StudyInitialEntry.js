...
const breadcrumbs = [
  ...
  { label: "banner.menu.createInitial", link: "/StudyInitialEntry" },
];

const StudyInitialEntry = () => {
  const intl = useIntl();
      ...
      <Grid fullWidth={true}>
        <Column lg={16} md={8} sm={4}>
          <Section>
            <Heading>
              <FormattedMessage
                id="sample.entry.study.initial.title"
                defaultMessage="Study - Initial Entry"
              />
            </Heading>
          </Section>
        </Column>
                      ...
                      <Button
                        ...
                        onClick={() =>
                          (window.location.href =
                            "/StudyInitialEntry?type=initial")
                        }
                      >
                        <FormattedMessage
...
export default StudyInitialEntry;
