          ...
          {value ? (
            <div className="image-with-overlay">
              ...
              <div className="image-overlay">
                <span className="overlay-text">  {intl.formatMessage({ id: "patient.photo.retake" })}</span>
              </div>
            </div>
          ) : (
            <div className="image-placeholder">
              <UserAvatar size={48} />
              <span className="placeholder-text"> {intl.formatMessage({ id: "patient.photo.add" })}</span>
            </div>
          )}
        </div>
      </div>
