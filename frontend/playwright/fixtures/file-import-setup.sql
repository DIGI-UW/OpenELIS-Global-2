...
SELECT
  ...
  (SELECT COUNT(*) FROM analyzer WHERE name = 'E2E-FILE-CSV-Analyzer') AS analyzer_count,
  (SELECT COUNT(*) FROM file_import_configuration fic JOIN analyzer a ON fic.analyzer_id = a.id WHERE a.name = 'E2E-FILE-CSV-Analyzer') AS file_config_count,
  (SELECT COUNT(*) FROM analyzer_plugin_config apc JOIN analyzer a ON apc.analyzer_id = a.id WHERE a.name = 'E2E-FILE-CSV-Analyzer') AS plugin_config_count;
