...
test.describe("QuantStudio 7 MVP Workflow", () => {
  ...
  test("create analyzer, configure file import, test connection", async ({
    ...
    await videoPause(page, VIDEO_PAUSE_LONG, testInfo);
    ...
    await videoPause(page, VIDEO_PAUSE_SHORT, testInfo);
    ...
    await videoPause(page, SHORT_PAUSE, testInfo);
    ...
    await videoPause(page, VIDEO_PAUSE_EXTENDED, testInfo);
