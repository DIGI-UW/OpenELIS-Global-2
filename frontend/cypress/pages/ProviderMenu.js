class ProviderMenuPage {
    get pageHeading() { return cy.get('h1'); }
    get searchInput() { return cy.get('input#provider-search-bar'); }
    get addButton() { return cy.contains('Add'); }
    get modifyButton() { return cy.contains('Modify'); }
    get deactivateButton() { return cy.contains('Deactivate'); }
    ...
    get faxInput() { return cy.get('input#fax'); }
    get activeDropdown() { return cy.get('div.dropdown-list'); }
    get tableRows() { return cy.get('table tbody tr'); }
    get paginationNextButton() { return cy.contains('Next'); }
    get paginationPreviousButton() { return cy.contains('Previous'); }
